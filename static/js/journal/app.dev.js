...
archive.init = function(selector) {
    ...
    getTokenCallback(function(token) {
        ...
        $.ajax({
                type: "GET",
				url : "https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/core/" + app.year + ":/children?select=id,name,size,createdDateTime,lastModifiedDateTime,@content.downloadUrl&top=500&orderby=lastModifiedDateTime%20desc&access_token=" + token
            })
            .done(function(data, status, xhr) {
                if (data["@odata.nextLink"]) {
