...
4).toLowerCase();var k={id:k,name:l,title:l.substring(0,l.length-4),url:m,size:h,resource:!1,change:!0},p=!0;if(".mp4"===e){for(e=0;e!==edit.videos.length;++e)if(edit.videos[e].size===h){p=!1;break}p&&(++d,edit.videos.push(k),edit.addMedia(-1,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}else if(".mp3"===e||".wav"===e){for(e=0;e!==edit.voices.length;++e)if(edit.voices[e].size===h){p=!1;break}p&&(++c,edit.voices.push(k),edit.addMedia(-3,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}}edit.playableSetToggle();
...
b.length;f!==g;++f){var k=b[f].id,h=b[f].size,l=b[f].name,m=b[f]["@content.downloadUrl"],p=l.substring(l.length-4).toLowerCase(),k={id:k,name:l,title:l.substring(0,l.length-4),url:m,size:h,resource:!1,change:!0};switch(a){case 1:if(".mp4"!==p)continue;break;case 3:if(".mp3"!==p&&".wav"!==p)continue}for(var p=!0,q=0;q!==c.length;++q)if(c[q].size===h){p=!1;break}if(p)switch(c.push(k),animation.log(edit.mediaName(a).capitalize()+log.EDIT_PANE_PLAYABLE_FILE+l+log.EDIT_PANE_PLAYABLE_FILE_ADDED),a){case 1:edit.addMedia(-1,
...
c;app.lastLoaded=b},processQualifiedEntry:function(a){var b=this;a=this.processFilter(a);app.qualifiedEntry=[];_.each(journal.archive.data[app.year],function(c,d){app.qualifiedEntry.push(b.qualify(c,a))})},processFilter:function(a){if(!a)return[];for(;-1!=a.search("  ");)a=a.replace("  "," ");var b=[];a=a.toLowerCase().split(" ");for(var c=0,d=a.length;c<d;++c){for(var e=a[c].split("|"),f={tags:[],attachments:[],keywords:[]},g=0,k=e.length;g<k;++g){var h=e[g];"#"===h[0]?f.tags.push(h.substr(1)):"%"===
h[0]?f.attachments.push(h.substr(1)):"@"===h[0]?f.timeRange=h.substr(1):(f.keywords.push(h),app.highlightWords.push(h))}b.push(f)}return b},qualify:function(a,b){for(var c=function(a,b){for(var c=0;c<a.length;++c)if(-1!==b.indexOf(a[c]))return!0;return!1},d=(a.tags||"").split("|"),e=app.tag().content(a.attachments||0),f=a.time.created,g=0;g<b.length;++g){var k=b[g];if(!(this.isInRange(k.timeRange||"",f)||c(d,k.tags)||c(e,k.attachments))){for(var h=0;h<k.keywords.length&&!(a.title&&a.title.match(new RegExp(k.keywords[h],
"i"))||a.text.body.match(new RegExp(k.keywords[h],"i")));++h);if(h===k.keywords.length)return!1}}return!0},date:function(a,b){var c=new Date(a),d=c.getHours(),e=c.getMinutes(),e=10>e?"0"+e:e,d=10>d?"0"+d:d;if(b)return d+":"+e;var f=c.getFullYear(),g=new Date,k=g.getFullYear(),h=c.getMonth(),l=c.getDate();if(f===k)if(k=new Date(f,0,1),f=Math.floor((c-k)/864E5),g=Math.floor((g-k)/864E5),f===g)g="Today";else if(f+1===g)g="Yesterday";else switch(k=k.getDay(),f=Math.floor((f-k)/7),k=Math.floor((g-k)/7),
g="",k-f){case 1:g="Last ";case 0:g+=app.weekArray[c.getDay()];break;default:g=app.monthArray[h]+" "+l}else g=app.monthArray[h]+" "+l;return g+" "+d+":"+e},html:function(a,b){a.summary=a.text.ext||a.text.body.substr(0,50);a.isBulb=0;if(a.contentType)a.contentType===app.contentType.BULB&&(a.ext="",a.isBulb=1);else{switch(!b&&a.attachments&1?1:a.coverType){default:a.type="text";a.ext="";break;case 1:a.type="photo";a.ext=this.thumb(a,"images");break;case 2:a.type="video";a.ext=this.thumb(a,"video");
break;case 3:a.type="music";a.ext=this.thumb(a,"music");break;case 4:a.type="voice";a.ext=this.thumb("dummy");break;case 5:a.type="book";a.ext=this.thumb(a,"book");break;case 6:a.type="movie";a.ext=this.thumb(a,"movie");break;case 7:a.type="place";a.ext=this.thumb("dummy");break;case 8:a.type="weblink",a.ext=this.thumb(a,"weblink")}a.attached=this.attached(a.attachments)}a.datetime=this.date(a.time.start||a.time.created);a.endtime="";a.time.end&&(a.datetime+=" - "+this.date(a.time.end,1));var c=$(app.itemView(a));
c.find(" > a").on("click",function(a){a.preventDefault();animation.showMenuOnly("edit");app.photos&&app.photos.remove();app.$list.find("ul li:nth-child("+(app.currentDisplayed+1)+") a").removeClass("display");$(this).addClass("display");app.currentDisplayed!=$(this).parent().index()&&(app.currentDisplayed=$(this).parent().index(),app.$detail.hide().fadeIn(500),app.view=new app.detail);return!1});a.contentType!==app.contentType.BULB&&($(".thumb > img:not([style])",c).on("load",function(){var a=app.util.crop(this.naturalWidth||
this.width,this.naturalHeight||this.height,160);$(this).css(a)}),$(".thumb > canvas",c).each(function(){var a=new Image,b=this.getContext("2d");a.src=$(this).data("src");a.onload=function(){var c=app.util.crop(this.width,this.height,160);b.drawImage(a,c.marginLeft||0,c.marginTop||0,c.width||160,c.height||160)}}));c=c.addClass(a.type).hide();this.contents.append(c.fadeIn(500))},htmlEmpty:function(){return $("#list ul").append("<li></li>")},thumb:function(a,b){var c=a[b],d;if(c&&0<c.length){c=c[0];
d="";if(!c.fileName)return'<div class="dummy"></div>';if("images"!=b&&"video"!=b)if(c.thumb)c=c.thumb;else return'<div class="dummy"></div>';var e=app.util.crop(1024,720,80),e=app.util.style(e),f;if("images"==b&&(journal.archive.map[c.fileName]&&(f=journal.archive.map[c.fileName].url),void 0==f)||"video"==b&&(journal.archive.map[c.fileName+"_thumb.jpg"]&&(f=journal.archive.map[c.fileName+"_thumb.jpg"].url),void 0==f))return'<div class="dummy"></div>';e&&(e=' style="'+e+'"');e='<img src="'+f+'"'+e+
">";Modernizr.canvas&&(e="<canvas style=\"background-image: url('"+f+"')\"></canvas>");1<c.urlType&&"weblink"==b&&(d='<span class="weblink-video"></span>');"video"==b&&(d='<span class="video-play"></span>');d='<div class="thumb">'+e+""+d+"</div>"}return d||'<div class="dummy"></div>'},attached:function(a){var b=[];a=app.tag().content(a);for(var c=0,d=a.length;c<d;++c)b.push('<span class="'+a[c]+'"></span>');return b.join("")},isInRange:function(a,b){var c=this.queryCache[a];if(!c){var c=[0,0],d=a.split(":");
1==d.length?c=this.getTimeRange(d[0]):(c[0]=this.getTimeRange(d[0])[0],c[1]=this.getTimeRange(d[1])[1]);this.queryCache[a]=c}return b>=c[0]&&b<=c[1]},getTimeRange:function(a){var b=[0,0];if(4==a.length){var c=parseInt(a.substr(0,2));a=parseInt(a.substr(2))+2E3;isNaN(c)||isNaN(a)||(b[0]=(new Date(a,c-1)).getTime(),b[1]=(new Date(a,c)).getTime()-1)}else if(6==a.length){var c=parseInt(a.substr(0,2)),d=parseInt(a.substr(2,2));a=parseInt(a.substr(4))+2E3;isNaN(a)||isNaN(c)||isNaN(d)||(b[0]=(new Date(a,
c-1,d)).getTime(),b[1]=b[0]+86399999)}return b},isInSameMonth:function(a,b){var c=(new Date(a)).getMonth();return 0===b?app.monthArray[c]:(new Date(b)).getMonth()===c?-1:app.monthArray[c]}};
...
[])})}).fail(function(a,c,d){animation.error(log.MEDIA_CLEAN_GET_FOLDERS_FAIL,d,-1)})}))};$(document).ready(function(){app.app=$("#app");app.contents=app.app.find(" > #contents");app.$list=$("#list");app.$detail=$("#detail");app.itemView=_.template($("#list-view").html());app.detailView=_.template($("#detail-view").html());calendar.viewTemplate=_.template($("#calendar-view").html());app.layout();app.initializeApp();archive.itemView=_.template($("#archive-view").html());archive.detailView=_.template($("#archive-detail-view").html())});
...
window.map=function(){var a={path:"M 0,0 0,0 z",fillOpacity:.8,scale:1,strokeColor:"red",strokeWeight:10},b=!1,c,d,e,f=0,g=[],k=[],h=-1,l=function(){for(var b=[],h=new google.maps.LatLngBounds,l=0,t=journal.archive.data[app.year].length;l<t;++l){var r=journal.archive.data[app.year][l];app.qualifiedEntry[l]&&r.contentType===app.contentType.BULB&&r.place&&function(e,l){var n={lat:parseFloat(e.place.latitude),lng:parseFloat(e.place.longitude)};b.push(n);h.extend(n);var n=new google.maps.Marker({position:n,
icon:a,map:c,title:(new Date(e.time.created)).toString()}),r='<div class="map-infowindow-container"><p class="bulb-date">'+(new Date(e.time.created)).toString()+'</p><p class="bulb-content">'+e.text.body+'</p><p class="location">'+(e.place.title||"")+'</p><div class="map-actions"><a href="javascript:;" onclick="map.showOlderBulb()" id="bulb-map-prev"></a><a href="javascript:;" onclick="map.showLaterBulb()" id="bulb-map-next"></a></div></div>',t=g.length;n.addListener("mouseover",function(){m(t)});
n.addListener("mouseout",function(){clearTimeout(f);f=setTimeout(function(){d.close()},5E3)});n.addListener("click",function(){var a=app.$list.find("li:nth-child("+l+")").find("a");a.click();app.$list.scrollTop(a.position().top)});g.push(n);k.push(r)}(r)}e=new google.maps.Polyline({path:b,geodesic:!0,strokeColor:"black",strokeOpacity:.7,strokeWeight:1});e.setMap(c);c.fitBounds(h)},m=function(a){a=a||h;clearTimeout(f);h=a;d.setContent(k[a]);d.open(c,g[a]);c.setCenter(g[a].position);c.setZoom(15)};
return{init:function(){c=new google.maps.Map(document.getElementById("map"),{zoom:4,center:{lat:-25.363,lng:131.044}});d=new google.maps.InfoWindow;b=!0;map.show()},show:function(){$("#list-tab").removeClass("list-only");b?(map.reset(),l()):map.init()},showOlderBulb:function(){++h>=g.length&&(h=g.length-1);m()},showLaterBulb:function(){0>--h&&(h=0);m()},hide:function(){$("#list-tab").addClass("list-only")},reset:function(){e&&e.setMap(null);for(var a=0;a<g.length;++a)g[a].setMap(null);g=[];k=[];h=
-1}}}();
