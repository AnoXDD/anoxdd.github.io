...
1)%7;++f)e.push(0)}a=$(calendar.viewTemplate({days:b,monthName:app.monthArray}));$("#data-calendar").html(a)},showContent:function(b){b=journal.archive.data[app.year];for(var d=b.length,e=(new Date(app.year,0,1)).getTime(),f=!1,g=0,h=0;h!==d;++h){var k=b[h],l=k.time.start||k.time.created;864E5<=l-e&&(e=new Date(e),e=$(".calendar-table .month-"+e.getMonth()+" .day-"+e.getDate()),f&&e.addClass("article"),e.addClass(a(g)),f=!1,g=0,l=new Date(l),e=new Date(app.year,l.getMonth(),l.getDate()));k.contentType===
app.contentType.BULB?++g:f=!0}},clear:function(){$(".calendar-table .day").removeClass("article bulb-0 bulb-1 bulb-2 bulb-3 bulb-4 bulb-5 bulb-6 bulb-7")}}}();
