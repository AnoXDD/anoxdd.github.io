...
a).prepend("<div class='bubble'><p class='article-no'>"+c+"</p><p class='bulb-no'>"+k+"</p></div>");a=new Date;if(app.year==a.getFullYear())for(a=a.getMonth();12!=a;++a)$("#month-"+a).addClass("hidden")},clear:function(){$(".calendar-table .day").removeClass("article bulb-0 bulb-1 bulb-2 bulb-3 bulb-4 bulb-5 bulb-6 bulb-7");d={};f={};$(".calendar-table").find(".bubble").remove();$(".month-cell").removeClass("hidden")},shrink:function(a){a=a||"";$("#calendar-thumbnail").text(a);$("#data-calendar").addClass("minimized");
$("#list").addClass("extended")},expand:function(){$("#data-calendar").removeClass("minimized");$("#list").removeClass("extended")}}}();
