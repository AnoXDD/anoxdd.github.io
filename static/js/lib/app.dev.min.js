...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var d=$jscomp.checkStringArgs(this,a,"startsWith");a+="";for(var f=d.length,e=a.length,g=Math.max(0,Math.min(c|0,d.length)),h=0;h<e&&g<f;)if(d[g++]!=a[h++])return!1;return h>=e}},"es6-impl","es3");$jscomp.polyfill("Array.prototype.entries",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return[a,c]})}},"es6-impl","es3");window.animation={};animation.isDebug=!0;
...
animation.log=function(a,b,c){var d=(new Date).getTime(),f;f="";1===b?f="start ":-1===b&&(0>--animation.indent&&(animation.indent=0),f="end ");0<animation.indent&&(f+="indent-"+animation.indent);c=c||0;switch(c){case 0:f='<p class="'+f+'" id='+d+">"+a+"</p>";break;case 1:f='<p class="'+f+' error" id='+d+">"+a+"</p>";break;case 2:f='<p class="'+f+' warning" id='+d+">"+a+"</p>";break;default:f='<p class="'+f+'" id='+d+">"+a+"</p>"}$("#feedback").empty();$(f).prependTo("#feedback").on("contextmenu",
...
[];for(var f=["video","voice"],e=0;e!==f.length;++e){var g;if("video"===f[e])g=edit.videos;else if("voice"===f[e])g=edit.voices;else break;if(d[f[e]])for(c=0;c!==d[f[e]].length;++c){var h=d[f[e]][c].fileName;journal.archive.map[h]&&g.push({name:h,title:d[f[e]][c].title,size:journal.archive.map[h].size,id:journal.archive.map[h].id,resource:!0,change:!1})}}console.log(Object.keys(d));var k=$(edit.editView(d));$("#search-new, #search-result").fadeOut();$("#contents").fadeOut(400,function(){var a;$("#edit-pane").html(k).fadeIn();
...
100==a.substring(4,6)||b.getFullYear()===app.year;if(c&&d&&a)return}b=(new Date).getTime();b=new Date(b-144E5);$(this).val(edit.format(b.getMonth()+1)+edit.format(b.getDate())+edit.format(b.getFullYear()%100)+" "+$(this).val())}});$("#entry-tag").keyup(function(a){13===a.keyCode&&(edit.addTag(),$("#entry-tag").val(""))});$("#attach-area .texttags .other p").click(function(){edit.removeTag($(this).text().substring(1))});$("#entry-time-wrap").mouseover(function(){var a=parseInt(localStorage.created)||
d.time.created,b=parseInt(localStorage.start)||d.time.start,c=parseInt(localStorage.end)||d.time.end,f=function(a){a=new Date(a);return isNaN(a.getTime())?"-":edit.format(a.getMonth()+1)+edit.format(a.getDate())+edit.format(a.getFullYear()%100)+" "+edit.format(a.getHours())+edit.format(a.getMinutes())};$("#entry-time-created").html(f(a));$("#entry-time-start").html(f(b));$("#entry-time-end").html(f(c))});var b=["music","book","movie"];for(a=0;a!==b.length;++a)for(var c=b[a],f=0;f!==$("#attach-area ."+
c).length;++f){var e=edit.getSelectorHeader(c,f),g=$(e+".title").val()+"%20"+$(e+".desc").val();getCoverPhoto(e,g,!1,c)}localStorage.title&&$("#entry-header").val(localStorage.title);localStorage.body&&$("#entry-body").text(localStorage.body);if(localStorage.coverType){b=-1;switch(parseInt(localStorage.coverType)){case 128:++b;case 16:++b;case 32:++b;case 4:++b;case 8:++b;case 64:++b;case 2:++b;case 1:++b}edit.coverSet(b)}b=app.tag().getIconsInHtml();c=app.tag().getIconsInName();f=app.tag().separate(localStorage.tags).iconTags;
for(a=0;a!==b.length;++a)e="#attach-area .icontags",e="w"===b[a].charAt(0)?e+" .weather":"e"===b[a].charAt(0)?e+" .emotion":e+" .unselected",$(e).append("<span class='icons "+b[a]+"' title="+c[a].capitalize()+" onclick=edit.toggleTag('"+c[a]+"',true)></span>");for(a=0;a!==b.length;++a)-1!==f.indexOf(b[a])&&edit.toggleIcon(c[a]);$("#entry-body").bind("keyup","return",function(){var b=$(this).get(0).selectionStart,c=$(this).get(0).selectionEnd,d=$(this).val(),f=d.lastIndexOf("\n",b-2),e=d.lastIndexOf("\t",
b-2);if(f<e){var g;if(e===b-2)g=d.substring(0,f+1),b=f;else for(g=d.substring(0,b),a=f+1;a!==e+1&&"\t"===d[a];++a)g+="\t";g+=d.substring(c);$(this).val(g);$(this).get(0).selectionStart=$(this).get(0).selectionEnd=b+1}edit.processBody()}).bind("keyup","space",function(){edit.refreshSummary()}).bind("keydown","tab",function(a){a.preventDefault();a=$(this).get(0).selectionStart;var b=$(this).get(0).selectionEnd;$(this).val($(this).val().substring(0,a)+"\t"+$(this).val().substring(b));$(this).get(0).selectionStart=
...
edit.exportCache=function(a){var b=journal.archive.data[app.year][a]||{},b=edit.exportCacheBody(b);b.processed=0;b.title=localStorage.title||"Untitled";b.tags=localStorage.tags||"";b.coverType=parseInt(localStorage.coverType);0>=b.coverType&&(b.coverType=edit.coverAuto());b.attachments||(b.attachments=0);for(var c,d=edit.mediaList,f=0,e=0;e<d.length;++e){c=localStorage[d[e]]?JSON.parse(localStorage[d[e]]):[];for(var g=0;g<c.length;++g)c[g]&&""!=c[g].title||c.splice(g--,1);b[d[e]]=0==c.length?void 0:
c;0==c.length?b[d[e]]=void 0:(f|=Math.pow(2,e),b[d[e]]=c)}b.attachments=f;0>a?journal.archive.data[app.year].push(b):(journal.archive.data[app.year][a]=b,app.currentDisplayed=-1)};
...
1);var f=["movie","music"];for(d=0;d!==f.length;++d)if(a[b][f[d]])for(var e=Object.keys(a[b][f[d]]),g=0;g!==e.length;++g)delete a[b][f[d]][e[g]].thumb;a[b].text.body=a[b].text.body.replace(/\r\n/g,"\n")}return a};edit.sortArchive=function(){journal.archive.data[app.year].sort(function(a,b){var c=b.time.created-a.time.created;return c?c:!!b.contentType-!!a.contentType})};
edit.removeDuplicate=function(){for(var a=0;a<Object.keys(journal.archive.data[app.year]).length-1;++a){var b=journal.archive.data[app.year][a],c=journal.archive.data[app.year][a+1];b.time.created===c.time.created&&b.contentType===c.contentType&&(app.yearChange[app.year]=!0,journal.archive.data[app.year].splice(a--,1))}};edit.undo=function(){};edit.change=function(a,b){};
edit.removeEntry=function(){if(-1==app.currentDisplayed)animation.error(log.NO_ENTRY_SELECTED),animation.deny("#delete");else{app.yearChange[app.year]=!0;$("#year-change").addClass("change");--app.displayedNum;var a=journal.archive.data[app.year][app.currentDisplayed];app.displayedChars-=a.text.chars||0;app.displayedLines-=a.text.lines||0;app.displayedTime-=(a.time.end-a.time.start)/6E4;delete journal.archive.data[app.year][app.currentDisplayed];a=$("#list ul li:nth-child("+(app.currentDisplayed+
...
edit.addMedia=function(a,b){var c="#attach-area ."+edit.mediaName(Math.abs(a)),d=$(c).length,f;switch(a){case 0:edit.photo();return;case 1:edit.videoSearch();break;case -1:f='<div class="video data change"><a class=\''+b.fileName+"' onclick=\"edit.video("+d+",'"+b.url+'\')" title="View"><div class="thumb"><span></span></div><input disabled class="title" value="'+b.title+'" /></a></div>';break;case 2:f='<div class="place"><a title="Edit" onclick="edit.location('+d+')" href="#"><div class="thumb"></div><input disabled title="Place" class="title place-search" autocomplete="off"/><input disabled title="Latitude" class="desc latitude" autocomplete="off" /><p>,</p><input disabled title="Longitude" class="desc longitude" autocomplete="off" /></a></div>';
break;case 3:edit.voiceSearch();break;case -3:f='<div class="voice data change"><a class=\''+b.fileName+"' onclick=\"edit.voice("+d+",'"+b.url+'\')" title="View"><div class="thumb"><span></span></div><input disabled class="title" value="'+b.title+'" /></a></div>';break;case 4:f='<div class="music"><a title="Edit" onclick="edit.music('+d+')" href="#"><img class="thumb"><span></span><input disabled class="title" placeholder="Track name" autocomplete="off" /><input disabled class="desc" placeholder="Artist" autocomplete="off" /></a></div>';
break;case 5:f='<div class="movie"><a title="Edit" onclick="edit.movie('+d+')" href="#"><img class="thumb"><span></span><input disabled class="title" placeholder="Movie title" autocomplete="off" onclick="this.select()" /><input disabled class="desc" placeholder="Director" autocomplete="off" onclick="this.select()" /></a></div>';break;case 6:f='<div class="book"><a title="Edit" onclick="edit.book('+d+')" href="#"><img class="thumb"><span></span><input disabled class="title" placeholder="Book title" autocomplete="off" onclick="this.select()" /><input disabled class="desc" placeholder="Author" autocomplete="off" onclick="this.select()" /></a></div>';
break;case 7:f='<div class="weblink"><a title="Edit" onclick="edit.weblink('+d+')" href="#"><div class="thumb"><span></span></div><input disabled class="title" placeholder="Title" /><input disabled class="desc" placeholder="http://" /></a></div>';break;default:return}0<d?$(f).insertAfter($(c+":eq("+(d-1)+")")):$(f).appendTo("#attach-area");0<a&&$(c+":eq("+d+") a").trigger("click")};edit.removeMedia=function(a){var b=edit.mediaName(a);edit.coverTest(b);switch(a){case 1:case 3:break;default:edit.addToRemovalList(b)}edit.cleanupMediaEdit()};
edit.addMediaFromQueue=function(){$("#return-lost-media").removeAttr("onclick");animation.log(log.QUEUE_START,1);network.init(1);edit.photo(!0,function(){network.next();getTokenCallback(function(a){$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/queue:/children?select=id,name,size,@content.downloadUrl&access_token="+a}).done(function(a,c,d){var f;a=a.value;for(var e=d=c=0,g=a.length;e!==g;++e){var h=a[e].id,k=a[e].size,l=a[e].name,m=a[e]["@content.downloadUrl"];f=l.substring(l.length-
4).toLowerCase();var h={id:h,name:l,title:l.substring(0,l.length-4),url:m,size:k,resource:!1,change:!0},n=!0;if(".mp4"===f){for(f=0;f!==edit.videos.length;++f)if(edit.videos[f].size===k){n=!1;break}n&&(++d,edit.videos.push(h),edit.addMedia(-1,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}else if(".mp3"===f||".wav"===f){for(f=0;f!==edit.voices.length;++f)if(edit.voices[f].size===k){n=!1;break}n&&(++c,edit.voices.push(h),edit.addMedia(-3,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}}edit.playableSetToggle();
...
edit.cleanupMediaEdit=function(){$("#edit-pane").off("keyup");switch(edit.isEditing){case 1:edit.videoHide();break;case 2:edit.locationHide();break;case 3:edit.voiceHide();break;case 4:edit.musicHide();break;case 5:edit.movieHide();break;case 6:edit.bookHide();break;case 7:edit.weblinkHide()}};edit.getSelectorHeader=function(a,b){return void 0==b?"#attach-area ."+a+":eq("+edit.mediaIndex[a]+") ":"#attach-area ."+a+":eq("+b+") "};edit.toggleLight=function(){$("#text-area").toggleClass("dark").children().toggleClass("dark")};
edit.fullScreen=function(){edit.cleanupMediaEdit();$(window).off("resize");$("#app").css("height","inherit");animation.showMenuOnly("fullscreen");$(".header").fadeOut(400);$("#attach-area").fadeOut(400);$("body").addClass("fullscreen");document.documentElement.requestFullscreen?document.documentElement.requestFullscreen():document.documentElement.msRequestFullscreen?document.documentElement.msRequestFullscreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():
document.documentElement.webkitRequestFullscreen&&document.documentElement.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT)};
edit.windowMode=function(){$("#text-area").removeClass("dark").children().removeClass("dark");animation.showMenuOnly("add");$(".header").fadeIn(400,function(){});$("body").removeClass("fullscreen");$("#attach-area").fadeIn();app.layout();document.exitFullscreen?document.exitFullscreen():document.msExitFullscreen?document.msExitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen&&document.webkitExitFullscreen()};
edit.saveTitle=function(){localStorage.title=$("#entry-header").val()};edit.refreshSummary=function(){var a=$("#entry-body").val(),b=a.length;$("#entry-char").text(b);$("#entry-line").text(a.split(/\r*\n/).length)};
edit.refreshTime=function(){++edit.time;var a=new Date,a=edit.format(a.getMonth()+1)+edit.format(a.getDate())+edit.format(a.getFullYear()%100)+" "+edit.format(a.getHours())+edit.format(a.getMinutes());$("#entry-time").text(a);$("#entry-elapsed").text(parseInt(edit.time/60)+":"+edit.format(edit.time%60))};edit.format=function(a){return 10>a?"0"+a:""+a};
edit.convertTime=function(a){var b=parseInt(a.substring(0,2)),c=parseInt(a.substring(2,4)),d=parseInt(a.substring(4,6)),f=0,e=0;6<a.length&&(f=parseInt(a.substring(7,9)),e=parseInt(a.substring(9,11)));return(new Date(2E3+d,b-1,c,f,e)).getTime()};
...
edit.addTag=function(a,b){a=(a=edit.autoCorrectTags[a]||a)||$("#entry-tag").val().toLowerCase().replace(/\|/g,"");a=a.replace(/ /g,"");if(-1!==localStorage.tags.split("|").indexOf(a))animation.warn(log.TAG_ADD_HEADER+a+log.TAG_ADDED_ALREADY),$("#entry-tag").effect("highlight",{color:"#000"},400);else{var c=!1,d=!1;$("#attach-area .icontags span").each(function(){if($(this).attr("title").toLowerCase()===a){c=!0;var f=$(this).parent().attr("class");"weather"!==f&&"emotion"!==f||!$(this).hasClass("hidden")?
$(this).hasClass("highlight")?(animation.warn(log.TAG_ICON_ADD_HEADER+a+log.TAG_ADDED_ALREADY),""!==$("#entry-tag").val()&&$("#entry-tag").effect("highlight",{color:"#000"},400)):(b||animation.log(log.TAG_ICON_ADD_HEADER+a+log.TAG_ADDED),edit.toggleIcon(a),d=!0):(animation.warn(log.TAG_ICON_ADD_HEADER+a+log.TAG_ADDED_FAILED),""!==$("#entry-tag").val()&&$("#entry-tag").effect("highlight",{color:"#000"},400))}});if(!c){$("#entry-tag").effect("highlight",{color:"#dadada"},400);var f="onclick=edit.removeTag('"+
a+"')";$("#attach-area .texttags .other").append("<p title='Click to remove' "+f+">#"+a+"</p>");d=!0}d&&(localStorage.tags=localStorage.tags?localStorage.tags+("|"+a):a)}};
edit.removeTag=function(a,b){for(var c=localStorage.tags.split("|"),d=0;d!==c.length;++d)if(c[d]===a){var f=!1;$("#attach-area .texttags p").each(function(){$(this).text()==="#"+a&&$(this).animate({width:"0"},function(){$(this).remove();f=!0})});if(!f){var e=!1;$("#attach-area .icontags .highlight").each(function(){e||$(this).attr("title").toLowerCase()!==a||(b||animation.log(log.TAG_ICON_ADD_HEADER+a+log.TAG_REMOVED),edit.toggleIcon(a),e=!0)})}c.splice(d,1);localStorage.tags=c.join("|");break}};
edit.toggleTag=function(a,b){-1!==localStorage.tags.split("|").indexOf(a)?edit.removeTag(a,b):edit.addTag(a,b)};
edit.toggleIcon=function(a){var b=app.tag().getHtmlByName(a);a="#attach-area .icontags span."+b;var c=$(a).parent().attr("class");$(a).toggleClass("highlight").hasClass("highlight")?"weather"===c||"emotion"===c?$("#attach-area .icontags ."+c+" span:not(."+b+")").addClass("hidden"):$("#attach-area .icontags .selected").append($(a).addClass("highlight").clone()):"weather"===c||"emotion"===c?$("#attach-area .icontags ."+c+" span").removeClass("hidden"):setTimeout(function(){$("#attach-area .icontags .selected ."+
b).remove()},400)};
edit.coverSet=function(a,b){var c,d=a;"string"==typeof a&&(d=edit.mediaValue(a));switch(d){case 0:c=1;break;case 1:c=2;break;case 2:c=64;break;case 3:c=8;break;case 4:c=4;break;case 5:c=32;break;case 6:c=16;break;case 7:c=128;break;default:c=0}$(".types p").removeClass("hidden selected");if(b&&localStorage.coverType==c)localStorage.coverType=c=-1;else{localStorage.coverType=c;var f=edit.mediaName(d);$(".types p:not(#"+edit.mediaName(d)+"-cover)").addClass("hidden");f?$(".types #"+edit.mediaName(d)+
...
edit.coverTest=function(a){var b=!1;$("#attach-area ."+a).each(function(){"none"!==$(this).css("display")&&(b=!0)});b||$("#attach-area .types #"+a+"-cover").trigger("click")};
edit.photo=function(a,b){"function"!=typeof b&&(b=function(){});if(0===edit.photos.length||a){var c=JSON.parse(localStorage.images);if(c.length&&0===Object.keys(journal.archive.map).length)animation.error(log.EDIT_PANE_IMAGES_FAIL+log.DOWNLOAD_PROMPT),animation.deny("#add-photo");else{var d=!1;"100px"!==$("#attach-area .images").css("height")&&a&&(d=!0,a=!1);$("#attach-area .images").css({height:"100px"}).hover(function(){edit.cleanupMediaEdit();$("#photo-preview").css("opacity","initial").show({effect:"fade",
duration:200})},function(){$("#photo-preview").hide({effect:"fade",duration:200})}).sortable({containment:"#attach-area .images",cursor:"crosshair",revert:!0}).disableSelection();var f=function(c){getTokenCallback(function(f){f=a?"https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/queue:/children?select=id,name,size,@content.downloadUrl&access_token="+f:getDataUrlHeader()+"/"+c+":/children?select=id,name,size,@content.downloadUrl&access_token="+f;$.ajax({type:"GET",url:f}).done(function(b){b["@odata.nextLink"]&&
!a&&animation.warn(log.EDIT_PANE_TOO_MANY_RESULTS);for(var c=b.value,d=b=0,f=c.length;d!==f;++d){var e=c[d].size,g=c[d].id,h=c[d].name,k=h.substring(h.length-4).toLowerCase(),u=!1;if(".jpg"===k||".png"===k){for(var k=0,v=edit.photos;k!==v.length;++k)if(v[k].size==e){u=!0;break}u||(e={name:h,id:g,url:c[d]["@content.downloadUrl"],size:e,resource:!1,change:!1},++b,edit.photos.push(e))}}for(k=a?edit.photos.length-b:0;k!==edit.photos.length;++k)c=a?'<div class="queue">':edit.photos[k].resource?'<div class="resource">':
'<div class="data">',c+='<span></span><img src="'+edit.photos[k].url+'"/></div>',$("#attach-area .images").append(c);$("#add-photo").html("&#xf03e").attr({onclick:"edit.addMedia(0)",href:"#"}).fadeIn();$("#attach-area .images div").each(function(){$(this).off("contextmenu");$(this).on("contextmenu",function(){$(this).toggleClass("change");return!1})});$("#attach-area .images img").each(function(){$(this).unbind("mouseenter mouseleave").hover(function(){$("#photo-preview img").animate({opacity:1},
200).attr("src",$(this).attr("src"))},function(){$("#photo-preview img").animate({opacity:0},0)})});a?animation.debug(b+log.QUEUE_FOUND_IMAGES):(edit.setRemove(0),0===edit.photos.length?animation.log(log.EDIT_PANE_IMAGES_END_NO_RESULT,-1):animation.log(log.EDIT_PANE_IMAGES_END,-1),animation.finished("#add-photo"))}).fail(function(b,f,e){a||($("#add-photo").html("&#xf03e").attr({onclick:"edit.addMedia(0)",href:"#"}),"Not Found"!==e||d?--animation.indent:(animation.error(log.EDIT_PANE_IMAGES_FAIL+log.EDIT_PANE_IMAGES_FIND_FAIL+
c,e,-1),animation.deny("#add-photo")))}).always(function(){d?edit.photo(!0,b):(b(),network.destroy())})})};if(a)$("#attach-area .images .queue").each(function(){for(var a=0;a!==edit.photos.length;++a){var b=$(this).children("img").attr("src");if(edit.photos[a].url===b){edit.photos.splice(a,1);break}}$(this).remove()}),f();else{$("#add-photo").removeAttr("onclick").removeAttr("href");edit.photos=[];for(var e=0;e<c.length;++e){var g=c[e].fileName;journal.archive.map[g]?edit.photos.push({name:g,id:journal.archive.map[g].id,
size:journal.archive.map[g].size,url:journal.archive.map[g].url,resource:!0,change:!1}):(c.splice(e--,1),localStorage.images=JSON.stringify(c))}edit.getDate(function(a){animation.log(log.EDIT_PANE_IMAGES_START+a+log.EDIT_PANE_IMAGES_START_END,1);f(a)})}}}else animation.error(log.EDIT_PANE_IMAGES_ALREADY_LOADED)};
edit.photoSave=function(a){if(0==edit.photos.length)a();else{var b=[],c=[];edit.getDate(function(d){$("#attach-area .images div").each(function(){for(var a=0;a!==edit.photos.length;++a)if($(this).children("img").attr("src")===edit.photos[a].url){edit.photos[a].change=$(this).hasClass("change");break}});for(var f=0;f!==edit.photos.length;++f){var e=edit.photos[f].name,g=edit.photos[f].id,h=edit.photos[f].resource;edit.photos[f].change&&(edit.photos[f].change=!1,b.push({name:e,id:g,resource:!h}))}var k=
"/drive/root:/Apps/Journal/resource/"+app.year,l="/drive/root:/Apps/Journal/data/"+app.year+"/"+d,m=0;0!==b.length?getTokenCallback(function(f){animation.log(log.EDIT_PANE_IMAGES_SAVE_START,1);for(var e=0;e!==b.length;++e){var g;g=b[e].name;var h="https://api.onedrive.com/v1.0/drive/items/"+b[e].id+"?select=id,name,size,@content.downloadUrl&access_token="+f;b[e].resource?(g=d+((new Date).getTime()+e)+g.substring(g.length-4),g={name:g,parentReference:{path:k}}):g={parentReference:{path:l}};$.ajax({type:"PATCH",
url:h,contentType:"application/json",data:JSON.stringify(g)}).done(function(a,c,d){c=a.id;d=a.name;for(var f=0;f!==edit.photos.length;++f)edit.photos[f].id==c&&(edit.photos[f].success=!0,edit.photos[f].name=d,journal.archive.map[a.name]={url:a["@content.downloadUrl"],size:a.size,id:a.id});animation.debug(++m+log.EDIT_PANE_IMAGES_OF+b.length+log.EDIT_PANE_IMAGES_TRASNFERRED)}).fail(function(a,b,c){++m;animation.error(log.EDIT_PANE_TRANSFERRED_FAILED+log.SERVER_RETURNS+c+log.SERVER_RETURNS_END);animation.warning("#add-photo")}).always(function(d,
f,e){var g;if(m===b.length){$("#attach-area .images div").each(function(){$(this).removeClass("change");for(g=0;g!==edit.photos.length;++g)if($(this).children("img").attr("src")===edit.photos[g].url){edit.photos[g].success&&(edit.photos[g].resource?($(this).addClass("data").removeClass("resource"),delete journal.archive.map[edit.photos[g].name]):$(this).addClass("resource").removeClass("queue data"),edit.photos[g].resource=!edit.photos[g].resource);break}});for(g=0;g!==edit.photos.length;++g)edit.photos[g].change=
!1,edit.photos[g].success=!1;$("#attach-area .images img").each(function(){for(g=0;g!==edit.photos.length;++g)edit.photos[g].url===$(this).attr("src")&&edit.photos[g].resource&&c.push({fileName:edit.photos[g].name})});localStorage.images=JSON.stringify(c);animation.log(log.EDIT_PANE_FINISHED_TRANSFER+edit.mediaName(0)+log.EDIT_PANE_FINISHED_TRANSFER_END,-1);a()}})}}):($("#attach-area .images img").each(function(){for(j=0;j!==edit.photos.length;++j)edit.photos[j].url===$(this).attr("src")&&edit.photos[j].resource&&
c.push({fileName:edit.photos[j].name})}),localStorage.images=JSON.stringify(c),a())})}};edit.photoHide=function(){$("#attach-area .images").animate({height:"0"}).fadeOut().html("")};
edit.video=function(a,b){if(a!=edit.mediaIndex.video&&void 0!=a){edit.cleanupMediaEdit();edit.mediaIndex.video=a;var c=edit.getSelectorHeader("video");edit.setRemove(1);edit.func=$(c+"a").attr("onclick");$(c+"a").removeAttr("onclick");$(c+"input").prop("disabled",!1);$("#edit-pane").keyup(function(a){27===a.keyCode&&edit.videoHide()});edit.isEditing=1;var d;if(b)d=b,$("#text-area #video-preview").fadeIn(),app.videoPlayer("#text-area #video-preview",d);else if(d=$(c+"a").attr("class"),journal.archive.map[d]){d=
journal.archive.map[d].url;if(void 0==d){animation.error(log.FILE_NOT_FOUND+$(c+".title").val());return}$("#text-area #video-preview").fadeIn();app.videoPlayer("#text-area #video-preview",d)}else animation.error(log.FILE_NOT_LOADED+$(c+".title")+log.DOWNLOAD_PROMPT);edit.setRemove(1)}};
edit.videoHide=function(){if(!(0>edit.mediaIndex.video)){$("#text-area #video-preview").fadeOut();app.videoPlayer.quit();var a=edit.getSelectorHeader("video");$(a+"input").prop("disabled",!0).off("keyup");edit.func?($(a+"a").attr("onclick",edit.func),edit.func=void 0):$(a+"a").attr("onclick","edit.video("+edit.mediaIndex.video+")");edit.videoSave(edit.mediaIndex.video);$("#edit-pane").off("keyup");animation.hideHiddenIcons();edit.mediaIndex.video=-1;edit.isEditing=-1}};
...
".longitude"):(pos=new google.maps.LatLng(a,c),edit.locationGeocode(pos))}})},function(){animation.error(log.LOCATION_PIN_FAIL)}):animation.error(log.LOCATION_PIN_FAIL);edit.isEditing=2;$(b+"input").prop("disabled",!1);$(b+"a").removeAttr("onclick");$("#edit-pane").keyup(function(a){27===a.keyCode&&edit.locationHide()})}};
edit.locationHide=function(){if(!(0>edit.mediaIndex.place)){var a=edit.getSelectorHeader("place");$(a+"input").prop("disabled",!0);$(a+"a").attr("onclick","edit.location("+edit.mediaIndex.place+")");edit.locationSave(edit.mediaIndex.place);$("#map-holder").fadeOut().html('<div id="map-selector"></div>');$("#pin-point").addClass("hidden");$("#edit-pane").off("keyup");animation.hideHiddenIcons();edit.mediaIndex.place=-1;edit.isEditing=""}};
edit.locationSave=function(a){var b=localStorage.place,c=edit.getSelectorHeader("place",a),d=parseFloat($(c+".latitude").val()),f=parseFloat($(c+".longitude").val()),e={},b=b?JSON.parse(b):[];e.title=$(c+".title").val();isNaN(d)||isNaN(f)||(e.latitude=d,e.longitude=f);b[a]=e;localStorage.place=JSON.stringify(b)};
...
edit.locationWeather=function(a){var b=!1;$("#attach-area .icontags .weather p").each(function(){$(this).hasClass("highlight")&&(b=!0)});b||(animation.debug(log.EDIT_PANE_WEATHER_START,1),a="https://api.forecast.io/forecast/6f1ee423e253fba5e40e3276ff3e6d33/"+a.lat()+","+a.lng()+","+parseInt((new Date).getTime()/1E3)+"?units=si",$.ajax({type:"GET",url:a,dataType:"jsonp"}).done(function(a,b,f){b=a.currently;f=b.icon;animation.log(log.EDIT_PANE_WEATHER_RESULT+b.temperature+log.EDIT_PANE_WEATHER_RESULT_END);
var e;"clear-day"===f||"clear-night"===f?e="w01":"cloudy"===f||"partly-cloudy-day"===f||"partly-cloudy-night"===f?e="w02":"rain"===f?e="w03":"snow"===f||"sleet"===f?e="w04":"wind"===f&&(e="w06");e?(animation.log(log.EDIT_PANE_WEATHER_END,-1),$("#attach-area .icontags ."+e).trigger("click")):animation.log(log.EDIT_PANE_WEATHER_END_FAIL+a.summary+log.EDIT_PANE_WEATHER_END_FAIL_END,-1)}))};
edit.voice=function(a,b){if(a!=edit.mediaIndex.voice&&void 0!=a){edit.cleanupMediaEdit();edit.mediaIndex.voice=a;var c=edit.getSelectorHeader("voice");edit.func=$(c+"a").attr("onclick");$(c+"a").removeAttr("onclick");$(c+"input").prop("disabled",!1);$("#edit-pane").keyup(function(a){27===a.keyCode&&edit.voiceHide()});edit.isEditing=3;var d;if(b)app.audioPlayer(c+"a",b);else if(d=$(c+"a").attr("class"),journal.archive.map[d]){d=journal.archive.map[d].url;if(void 0==d){animation.error(log.FILE_NOT_FOUND+
...
edit.voiceHide=function(){if(!(0>edit.mediaIndex.voice)){app.videoPlayer.quit();var a=edit.getSelectorHeader("voice");$(a+"input").prop("disabled",!0).off("keyup");edit.func?($(a+"a").attr("onclick",edit.func),edit.func=void 0):$(a+"a").attr("onclick","edit.voice("+edit.mediaIndex.voice+")");edit.voiceSave(edit.mediaIndex.voice);$("#edit-pane").off("keyup");animation.hideHiddenIcons();edit.mediaIndex.voice=-1;edit.isEditing=-1}};
...
edit.movieSave=function(a){edit.itunesSave(a,5)};edit.book=function(a){edit.itunes(a,6)};edit.bookHide=function(){edit.itunesHide(6)};edit.bookSave=function(a){edit.itunesHide(a,6)};
edit.weblink=function(a){a!=edit.mediaIndex.weblink&&void 0!=a&&(edit.cleanupMediaEdit(),edit.mediaIndex.weblink=a,a=edit.getSelectorHeader("weblink"),edit.setRemove(7),$(a+"a").removeAttr("onclick"),$(a+"input").prop("disabled",!1),$("#edit-pane").keyup(function(a){27==a.keyCode&&edit.weblinkHide(7)}),edit.isEditing=7)};
edit.weblinkHide=function(){if(!(0>edit.mediaIndex.weblink)){var a=edit.getSelectorHeader("weblink");$(a+"input").prop("disabled",!0).off("keyup");$(a+"a").attr("onclick","edit.weblink("+edit.mediaIndex.weblink+")");edit.weblinkSave(edit.mediaIndex.weblink,7);$("#edit-pane").off("keyup");animation.hideHiddenIcons();edit.mediaIndex.weblink=-1;edit.isEditing=-1}};
...
edit.itunes=function(a,b){var c=edit.mediaName(b);if(a!=edit.mediaIndex[c]&&void 0!=a){edit.cleanupMediaEdit();edit.mediaIndex[c]=a;var d=edit.getSelectorHeader(c);edit.setRemove(b);$(d+"a").removeAttr("onclick");$(d+"input").prop("disabled",!1).keyup(function(a){13==a.keyCode&&(a=$(d+".title").val()+"%20"+$(d+".desc").val(),getCoverPhoto(d,a,!0,b))});$("#edit-pane").keyup(function(a){27==a.keyCode&&edit.itunesHide(b)});edit.isEditing=b}};
edit.itunesHide=function(a){var b=edit.mediaName(a);if(!(0>edit.mediaIndex[b])){var c=edit.getSelectorHeader(b);$(c+"input").prop("disabled",!0).off("keyup");$(c+"a").attr("onclick","edit."+b+"("+edit.mediaIndex[b]+")");edit.itunesSave(edit.mediaIndex[b],a);$("#edit-pane").off("keyup");animation.hideHiddenIcons();edit.mediaIndex[b]=-1;edit.isEditing=-1}};
edit.itunesSave=function(a,b){var c=edit.mediaName(b),d=localStorage[c],f=edit.getSelectorHeader(c,a),e=$(f+".title").val(),f=$(f+".desc").val(),d=d?JSON.parse(d):[];d[a]={title:e,author:f};localStorage[c]=JSON.stringify(d)};
edit.playableSearch=function(a){getTokenCallback(function(b){edit.getDate(function(c){c=getDataUrlHeader()+"/"+c+":/children?select=id,name,size,@content.downloadUrl&access_token="+b;animation.log(log.EDIT_PANE_PLAYABLE_SEARCH_START,1);$.ajax({type:"GET",url:c}).done(function(b,c,e){b["@odata.nextLink"]&&animation.warn(log.EDIT_PANE_TOO_MANY_RESULTS);b=b.value;switch(a){case 1:c=edit.videos;break;case 3:c=edit.voices;break;default:console.log("edit.playableSearch()\tInvalid call");return}e=0;for(var g=
b.length;e!==g;++e){var h=b[e].id,k=b[e].size,l=b[e].name,m=b[e]["@content.downloadUrl"],n=l.substring(l.length-4).toLowerCase(),h={id:h,name:l,title:l.substring(0,l.length-4),url:m,size:k,resource:!1,change:!0};switch(a){case 1:if(".mp4"!==n)continue;break;case 3:if(".mp3"!==n&&".wav"!==n)continue}for(var n=!0,p=0;p!==c.length;++p)if(c[p].size===k){n=!1;break}if(n)switch(c.push(h),animation.log(edit.mediaName(a).capitalize()+log.EDIT_PANE_PLAYABLE_FILE+l+log.EDIT_PANE_PLAYABLE_FILE_ADDED),a){case 1:edit.addMedia(-1,
{fileName:l,url:m,title:l.substring(0,l.length-4)});break;case 3:edit.addMedia(-3,{fileName:l,url:m,title:l.substring(0,l.length-4)})}}edit.playableSetToggle();animation.log(log.EDIT_PANE_PLAYABLE_SEARCH_END,-1)}).fail(function(b,c,e){animation.error(log.EDIT_PANE_PLAYABLE_SEARCH_FAILED,e,-1);switch(a){case 1:animation.warning("#add-video");break;case 3:animation.warning("#add-voice")}})})})};
...
edit.playableSave=function(a,b){edit.getDate(function(c){var d="/drive/root:/Apps/Journal/resource/"+app.year,f="/drive/root:/Apps/Journal/data/"+app.year+"/"+c,e,g,h=0;switch(a){case 1:e=edit.videos;g=JSON.parse(localStorage.video);break;case 3:e=edit.voices;g=JSON.parse(localStorage.voice);break;default:return}$("#attach-area ."+edit.mediaName(a)).each(function(){for(var a=0;a!==e.length;++a)if($(this).children("a").hasClass(e[a].name)&&(e[a].resource&&$(this).hasClass("resource")||!e[a].resource&&
$(this).hasClass("data"))){e[a].change=$(this).hasClass("change");break}});for(var k=0;k!==g.length;++k)for(var l=0;l!==e.length;++l)if(g[k]&&g[k].fileName===e[l].name){e[l].title=g[k].title;break}for(k=0;k!==e.length;++k)e[k].change&&++h;0===h?($("#attach-area ."+edit.mediaName(a)).each(function(){$(this).hasClass("data")&&$(this).addClass("ignore").empty().fadeOut()}),b()):getTokenCallback(function(l){animation.log(log.EDIT_PANE_PLAYABLE_SAVE_START+edit.mediaName(a)+log.EDIT_PANE_PLAYABLE_SAVE_START_END,
1);for(var k=0;k!==e.length;++k)if(e[k].change){var p=e[k].name,q=e[k].title,w=e[k].id,r=c+((new Date).getTime()+k)+p.substring(p.length-4);e[k].success=!1;if(e[k].resource){for(var t=0;t!==g.length;++t)if(g[t].fileName===p){r=q+p.substring(p.length-4);break}q=f}else q=d;r={name:r,parentReference:{path:q}};w?p="https://api.onedrive.com/v1.0/drive/items/"+w+"?select=id,name,size,@content.downloadUrl&access_token="+l:(q=q===d?f:d,p="https://api.onedrive.com/v1.0"+q+"/"+encodeURI(p)+"?select=name,size,@content.downloadUrl&access_token="+
l);$.ajax({type:"PATCH",url:p,contentType:"application/json",data:JSON.stringify(r)}).done(function(b){--h;for(var c="",d=0;d!==e.length;++d)if(e[d].id===b.id){c=e[d].title;e[d].success=!0;delete journal.archive.map[e[d].name];if(!e[d].resource){var f=b.name;e[d].newName=f;journal.archive.map[f]={id:b.id,size:b.size,url:b["@content.downloadUrl"]}}break}animation.log(edit.mediaName(a).capitalize()+log.EDIT_PANE_PLAYABLE_FILE+c+log.EDIT_PANE_PLAYABLE_FILE_SAVED)}).fail(function(b,c,d){--h;animation.warn(log.EDIT_PANE_TRANSFERRED_FAILED,
d,!1);animation.warning("#add-"+edit.mediaName(a))}).always(function(){if(0>=h){$("#attach-area ."+edit.mediaName(a)).each(function(){$(this).removeClass("change");for(var a=0;a!==e.length;++a)if(!$(this).hasClass("ignore")&&$(this).children("a").hasClass(e[a].name)&&(e[a].resource&&$(this).hasClass("resource")||!e[a].resource&&$(this).hasClass("data"))){e[a].success&&(e[a].success=!1,e[a].resource=!e[a].resource,$(this).hasClass("resource")?$(this).removeClass("resource").addClass("data"):$(this).hasClass("data")&&
$(this).removeClass("data").addClass("resource"),e[a].newName&&(e[a].name=e[a].newName,$(this).children("a").attr("class",e[a].newName),delete e[a].newName));break}$(this).hasClass("data")&&$(this).addClass("ignore").empty().fadeOut()});for(var c=[],d=0;d!==e.length;++d)e[d].change=!1,e[d].resource?c.push({fileName:e[d].newName||e[d].name,title:e[d].title}):(e.splice(d,1),--d);localStorage[edit.mediaName(a)]=JSON.stringify(c);animation.log(log.EDIT_PANE_FINISHED_TRANSFER+edit.mediaName(a)+log.EDIT_PANE_FINISHED_TRANSFER_END,
...
f=function(){var a=[];journal.archive.data[app.year]=journal.archive.data[app.year].filter(function(b){if(void 0==b)return app.yearChange[app.year]=!0,!1;var c=b.time,d=(new Date(c.created)).getFullYear(),c=(new Date(c.created)).getFullYear();if(d==app.year||c==app.year)return!0;app.yearQueue[d]||(app.yearQueue[d]=[]);app.yearQueue[d].push(b);app.yearChange[d]=!0;app.yearChange[app.year]=!0;$("#year").addClass("change");$("#last-updated").addClass("change");-1===a.indexOf(d)&&a.push(d);return!1});
return a},e=function(a){animation.indent=0;animation.debug(log.CONTENTS_RELOADED);animation.testAllSubs();console.log("==================Force loaded==================");$("#list").empty();app.lastLoaded=0;app.lastQualified=-1;app.displayedChars=0;app.displayedLines=0;app.displayedNum=0;app.displayedTime=0;app.currentDisplayed=-1;app.command=a;$("#query").val(a);$("#total-displayed").text(app.displayedNum);$("#total-char").text(app.displayedChars);$("#total-line").text(app.displayedLines);$("#total-time").text(app.displayedTime);
$("#year").effect("slide",{direction:"up"}).html(app.year);app.yearChange[app.year]?($("#year").addClass("change"),$("#last-updated").addClass("change")):$("#year").removeClass("change");a=0;for(var b=journal.archive.data[app.year].length;a!=b;++a)journal.archive.data[app.year][a].processed=0},g=function(){app.yearQueue[app.year]&&(app.yearChange[app.year]=!0,journal.archive.data[app.year].push.apply(journal.archive.data[app.year],app.yearQueue[app.year]),edit.sortArchive(),edit.removeDuplicate(),
delete app.yearQueue[app.year]);var a=f();if(0<a.length){animation.log(log.DATA_MOVED_TO_OTHER_YEAR+a.join(", ")+log.DATA_MOVED_TO_OTHER_YEAR_END);for(var b=0;b!==a.length;++b)-1===app.years.indexOf(a[b])&&app.years.push(a[b]);app.years.sort()}},h=function(a,b){console.log("app.loadScript(): data.length = "+a.length);var c="",d;for(d=0;d!==a.length&&"["!=a[d];++d)c+=a[d];(c=parseInt(c))&&(app.version[app.year]=c);journal.archive.data[app.year]=app.updateData(JSON.parse(a.substr(d)));b()},k=function(a){$("#total-entry").text(journal.archive.data[app.year].length);
new app.list(a);app.dataLoaded[app.year]=!0};return{resource:"resource/",monthArray:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekArray:"Sun Mon Tue Wed Thu Fri Sat".split(" "),year:(new Date).getFullYear(),years:[],yearQueue:{},yearChange:{},lastLoaded:0,currentDisplayed:-1,displayedNum:0,displayedLines:0,displayedChars:0,displayedTime:0,lastQualified:-1,pageLoaded:1,preloadedTags:[],command:"",isFunction:!0,lostMedia:[],dataLoaded:{},lastUpdated:{},version:{data:2},contentType:{BULB:1},
initializeApp:function(){showLoginButton();app.preloadedTags.push("%photo","%video","%music","%voice","%book","%movie","%place","%weblink");for(var f=app.tag().getIconsInName(),e=0;e!=f.length;++e)app.preloadedTags.push("#"+f[e]);a(this);b();c();$("#year").effect("slide",{direction:"up"});app.getYears();d();animation.testCacheIcons();animation.testAllSubs();calendar.initView();calendar.showContent()},addLoadDataWithFilter:function(a,b){if(""==b)animation.error(log.LOAD_DATA_FAIL+log.NO_CONTENT),animation.deny("#refresh-media");
else{if(void 0==b&&(journal.archive.data[app.year]||(journal.archive.data[app.year]=[]),g(),0===journal.archive.data[app.year].length)){animation.warn(log.LOAD_DATA_FAIL+log.NO_ARCHIVE);animation.deny("#refresh-media");return}var c=$("#search-result");c.hide();app.detail.prototype.hideDetail();animation.testAllSubs();!app.dataLoaded[app.year]&&b&&(animation.debug(log.CONTENTS_NEW+b.length+log.CONTENTS_NEW_END),console.log("addLoadDataWithFilter(): data.length = "+b.length),h(b,function(){k(a)}),edit.saveDataCache());
e(a);k(a);c.fadeIn(500)}},refresh:function(){app.addLoadDataWithFilter("")},updateData:function(a){app.version[app.year]||(app.version[app.year]=1);if(app.version[app.year]!==app.version.data)switch(animation.debug(log.CONTENTS_UPGRADING),app.version[app.year]){case 1:for(var b=0;b!==a.length;++b){var c=a[b].iconTags;c&&app.tag().getIconsInNameByVal(c).join("|");delete a[b].icontags;delete a[b].textTags}app.version[app.year]=2}app.version[app.year]>app.version.data&&(app.version[app.year]=app.version.data);
return a},getYears:function(){animation.log(log.GET_YEARS_START);getTokenCallback(function(a){$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/core:/children?select=name,createdBy&orderby=name&access_token="+a}).done(function(a){a=a.value;app.years=[];for(var b=0;b!==a.length;++b){var c=a[b].name;parseInt(c)==c&&(c=parseInt(c),app.years.push(c),network.yearFolders.push(c))}app.user=a[0].createdBy.user.displayName;$("#username").html(app.user);-1===app.years.indexOf((new Date).getFullYear())&&
app.years.push((new Date).getFullYear());backupAll();animation.testYearButton();animation.log(log.GET_YEARS_END)}).fail(function(a,b,c){animation.error(log.GET_YEARS_FAIL,c);app.getYears()})})},yearUpdateTry:function(a){app.year=a;0===app.years.length&&app.years.push(app.year);journal.archive.data[a]?app.yearUpdate(a):downloadFile(void 0,!0)},yearUpdate:function(){app.refresh();animation.testYearButton();animation.debug(log.YEAR_SWITCHED_TO+app.year)},prev:function(a){if(network.isAjaxActive)animation.warn(log.NETWORK_WORKING);
else{var b=app.years.indexOf(app.year);-1===b?app.yearUpdateTry((new Date).getFullYear()):(a?b=0:--b,app.yearUpdateTry(app.years[b]))}},next:function(a){if(network.isAjaxActive)animation.warn(log.NETWORK_WORKING);else{var b=app.years.indexOf(app.year);-1===b?app.yearUpdateTry((new Date).getFullYear()):(a?b=app.years.length-1:++b,app.yearUpdateTry(app.years[b]))}},updateLastUpdated:function(a){a=parseInt(a)||(new Date).getTime();app.lastUpdated[app.year]=a;app.year===(new Date).getFullYear()&&(localStorage.lastUpdated=
(new Date).getTime());app.readLastUpdated()},readLastUpdated:function(){var a=app.lastUpdated[app.year];a?a=archive.list.prototype.date(a):app.year===(new Date).getFullYear()?localStorage.lastUpdated?(a=parseInt(localStorage.lastUpdated),app.lastUpdated[app.year]=a,a=archive.list.prototype.date(a)):a="N/A":a="N/A";$("#last-updated").html(a)},isBulbExist:function(a){},addBulb:function(a,b){var c=a.content||a.contentRaw,c={contentType:app.contentType.BULB,time:{created:b},text:{body:c,chars:c.length}};
a.location&&(c.place={latitude:a.location.lat,longitude:a.location["long"]},c.place.title=a.location.name||"");a.website&&(c.weblink={url:a.website});journal.archive.data[app.year].push(c);$("#year").addClass("change");bulb.setIsMerged(b)},finishMergingBulbs:function(){animation.log(log.BULB_FETCH_END+(bulb.getTotalAvailableBulbs()-bulb.getMergedBulbCounter()));edit.removeDuplicate();edit.sortArchive();app.refresh();bulb.isProcessing=!1;uploadFile(void 0,function(){animation.log(log.BULB_REMOVE_MERGED_START);
bulb.removeUploadedBulbs()})}}}();
app.list=function(a){var b=this;journal.total=journal.archive.data[app.year].length;var c=app.cList,d=c.children("ul");if(!this.contents&&1>d.length){c.html('<ul></ul><div class="loadmore"></div>');this.contents=c.children("ul");this.loadmore=c.children("div.loadmore");this.loadmore.on("click",function(){b.load(a)});for(this.load(a);0!=$(".loadmore").length;)b.load(app.command);c.off("scroll").on("scroll",function(){$(this).scrollTop()>b.contents.height()-c.height()&&0!=$(".loadmore").length&&b.load(app.command)})}};
app.list.prototype={load:function(a){var b=journal.archive.data[app.year],c=app.lastLoaded,d=app.lastQualified;app.lastLoaded>=journal.archive.data[app.year].length&&(c=app.lastLoaded=journal.archive.data[app.year].length-1);for(b[c].index=c;;)if(this.qualify(b[c],a)){this.html(journal.archive.data[app.year][c],-1==d?0:b[d].time.start||b[d].time.created);d=c;++app.displayedNum;app.displayedChars+=b[c].text.chars||0;app.displayedLines+=b[c].text.lines||0;if(b[c].time.end){var f=parseInt((b[c].time.end-
b[c].time.start)/6E4);isNaN(f)||(app.displayedTime+=f)}if($("#list").get(0).scrollHeight!=$("#list").height()||++c==journal.total)break}else if(this.htmlEmpty(),++c==journal.total)break;$("#search-result").hide().fadeIn(500);$("#total-displayed").text(app.displayedNum);$("#total-char").text(app.displayedChars);$("#total-line").text(app.displayedLines);$("#total-time").text(app.displayedTime);++c>=journal.total&&($(".loadmore").remove(),$("#list").append('<li><p class="separator"><span>EOF</span></p></li>'));
app.lastQualified=d;app.lastLoaded=c},qualify:function(a,b){if(!b)return!0;for(;-1!=b.search("  ");)b=b.replace("  "," ");for(var c=b.toLowerCase().split(" "),d=0,f=c.length;d<f;++d){var e=c[d].split("|"),g=!1;console.log("\t\t> Testing "+e);for(var h in e)if(e.hasOwnProperty(h)){var k;if("#"===e[h].charAt(0)){if(a.tags&&(k=!1,-1!==a.tags.split("|").indexOf(e[h].substr(1))&&(k=!0),k)){g=!0;break}}else if("%"===e[h].charAt(0)){k=!1;for(var l=app.tag().content(a.attachments),m=e[h].substr(1),n=0;n!==
l.length;++n)if(m==l[n]){k=!0;break}if(k){g=!0;break}}else if("@"===e[h].charAt(0)){if(k=e[h].substr(1),this.isInRange(k,a.time.created)){console.log("\t- Time match!");g=!0;break}}else if("+"===e[h].charAt(0)){if(a.text.body.match(new RegExp(e[h].substr(1),"i"))){g=!0;break}}else if(a.title.match(new RegExp(e[h],"i"))){g=!0;break}if(g)break}if(!g)return console.log("Reach end"),!1}return!0},date:function(a,b){var c=new Date(a),d=c.getHours(),f=c.getMinutes(),f=10>f?"0"+f:f,d=10>d?"0"+d:d;if(b)return d+
":"+f;var e=c.getFullYear(),g=new Date,h=g.getFullYear(),k=c.getMonth(),l=c.getDate();if(e===h)if(h=new Date(e,0,1),e=Math.floor((c-h)/864E5),g=Math.floor((g-h)/864E5),e===g)g="Today";else if(e+1===g)g="Yesterday";else switch(h=h.getDay(),e=Math.floor((e-h)/7),h=Math.floor((g-h)/7),g="",h-e){case 1:g="Last ";case 0:g+=app.weekArray[c.getDay()];break;default:g=app.monthArray[k]+" "+l}else g=app.monthArray[k]+" "+l;return g+" "+d+":"+f},html:function(a,b){a.summary=a.text.ext||a.text.body.substr(0,
50);a.isBulb=0;if(a.contentType)a.contentType===app.contentType.BULB&&(a.ext="",a.isBulb=1);else{switch(a.coverType){default:a.type="text";a.ext="";break;case 1:a.type="photo";a.ext=this.thumb(a,"images");break;case 2:a.type="video";a.ext=this.thumb(a,"video");break;case 3:a.type="music";a.ext=this.thumb(a,"music");break;case 4:a.type="voice";a.ext=this.thumb("dummy");break;case 5:a.type="book";a.ext=this.thumb(a,"book");break;case 6:a.type="movie";a.ext=this.thumb(a,"movie");break;case 7:a.type=
"place";a.ext=this.thumb("dummy");break;case 8:a.type="weblink",a.ext=this.thumb(a,"weblink")}a.attached=this.attached(a.attachments)}var c=a.time.start||a.time.created;a.datetime=this.date(c);a.endtime="";a.time.end&&(a.datetime+=" - "+this.date(a.time.end,1));a.month=this.isInSameMonth(c,b);c=$(app.itemView(a));c.find(" > a").on("click",function(a){a.preventDefault();animation.showMenuOnly("edit");app.photos&&app.photos.remove();$("#list").find("ul li:nth-child("+(app.currentDisplayed+1)+") a").removeClass("display");
$(this).addClass("display");app.currentDisplayed!=$(this).parent().index()&&(app.currentDisplayed=$(this).parent().index(),$("#detail").hide().fadeIn(500),app.view=new app.detail);return!1});a.contentType!==app.contentType.BULB&&($(".thumb > img:not([style])",c).on("load",function(){var a=app.util.crop(this.naturalWidth||this.width,this.naturalHeight||this.height,160);$(this).css(a)}),$(".thumb > canvas",c).each(function(){var a=new Image,b=this.getContext("2d");a.src=$(this).data("src");a.onload=
function(){var c=app.util.crop(this.width,this.height,160);b.drawImage(a,c.marginLeft||0,c.marginTop||0,c.width||160,c.height||160)}}));c=c.addClass(a.type).hide();this.contents.append(c.fadeIn(500))},htmlEmpty:function(){console.log("not show!");return $("#list ul").append("<li></li>")},thumb:function(a,b){var c=a[b],d;if(c&&0<c.length){c=c[0];d="";if(!c.fileName)return'<div class="dummy"></div>';if("images"!=b&&"video"!=b)if(c.thumb)c=c.thumb;else return'<div class="dummy"></div>';var f=app.util.crop(1024,
720,80),f=app.util.style(f),e;if("images"==b&&(journal.archive.map[c.fileName]&&(e=journal.archive.map[c.fileName].url),void 0==e)||"video"==b&&(journal.archive.map[c.fileName+"_thumb.jpg"]&&(e=journal.archive.map[c.fileName+"_thumb.jpg"].url),void 0==e))return'<div class="dummy"></div>';f&&(f=' style="'+f+'"');f='<img src="'+e+'"'+f+">";Modernizr.canvas&&(f='<canvas width="160" height="160" data-src="'+e+'"></canvas>');1<c.urlType&&"weblink"==b&&(d='<span class="weblink-video"></span>');"video"==
b&&(d='<span class="video-play"></span>');d='<div class="thumb">'+f+""+d+"</div>"}return d||'<div class="dummy"></div>'},attached:function(a){var b=[];a=app.tag().content(a);for(var c=0,d=a.length;c<d;++c)b.push('<span class="'+a[c]+'"></span>');return b.join("")},isInRange:function(a,b){console.log("Call addLoadDataWithFilter.isInRange("+a+","+b+")");var c=a.split(":"),d=new Date(b);if(1==c.length){var f=c[0];if(4==f.length){var e=parseInt(f.substr(0,2)),g=parseInt(f.substr(2,2));return isNaN(e)||
isNaN(g)?!1:d.getYear()%100==g&&d.getMonth()+1==e}return 6==f.length?(e=parseInt(f.substr(0,2)),c=parseInt(f.substr(2,2)),g=parseInt(f.substr(4,2)),isNaN(e)||isNaN(c)||isNaN(g)?!1:d.getYear()%100==g&&d.getMonth()+1==e&&d.getDate()==c):!1}if(2==c.length){f=c[0];e=c[1];if(4==f.length){var c=parseInt(f.substr(0,2)),f=parseInt(f.substr(2,2)),h=parseInt(e.substr(0,2)),k;if(2==e.length)k=f;else if(4==e.length)k=parseInt(e.substr(2,2));else return!1;if(isNaN(c)||isNaN(f)||isNaN(h)||isNaN(k))return!1;e=d.getMonth()+
1;g=d.getYear()%100;return e>=c&&e<=h&&g>=f&&g<=k?!0:!1}if(6==f.length){c=parseInt(f.substr(0,2));d=parseInt(f.substr(2,2));f=parseInt(f.substr(4,2));h=c;k=f;if(2==e.length)g=parseInt(e);else if(4==e.length)h=parseInt(e.substr(0,2)),g=parseInt(e.substr(2,2));else if(6==e.length)h=parseInt(e.substr(0,2)),g=parseInt(e.substr(2,2)),k=parseInt(e.substr(4,2));else return!1;if(isNaN(c)||isNaN(d)||isNaN(f)||isNaN(h)||isNaN(g)||isNaN(e))return!1;h=new Date(2E3+k,h-1,g,23,59,59);return new Date(2E3+f,c-1,
d)<b&&h>b}return!1}},isInSameMonth:function(a,b){var c=(new Date(a)).getMonth();return 0===b?app.monthArray[c]:(new Date(b)).getMonth()===c?-1:app.monthArray[c]}};
app.detail=function(){var a=journal.archive.data[app.year][app.currentDisplayed];if(!a.processed){if(a.contentType===app.contentType.BULB)a.title="",a.chars=a.text.chars+" Chars",a.contents=this.text(a.text.body),a.weblink=a.weblink||void 0,a.place=a.place||void 0;else{a.chars=a.text.chars+" Chars";a.lines=a.text.lines+" Lines";a.contents=this.text(a.text.body);a.weblink&&this.thumb(a,"weblink",50,50);if(a.book){this.thumb(a,"book",50,70);for(var b=0;b!==a.book.length;++b)getCoverPhoto("#detail .book:eq("+
b+") ",a.book[b].author+" "+a.book[b].title,!1,"book")}if(a.music)for(this.thumb(a,"music",50,50),b=0;b!==a.music.length;++b)getCoverPhoto("#detail .music:eq("+b+") ",a.music[b].author+" "+a.music[b].title);if(a.movie)for(this.thumb(a,"movie",50,70),b=0;b!==a.movie.length;++b)getCoverPhoto("#detail .movie:eq("+b+") ",a.movie[b].author+" "+a.movie[b].title,!1,"movie");a.tags?(b=app.tag().separate(a.tags),a.iconTags=b.iconTags||[],a.textTags=b.textTags||[]):(a.iconTags=[],a.textTags=[]);for(var c="video weblink book music movie images voice place textTags iconTags".split(" "),
b=0,d=c.length;b<d;++b)void 0==a[c[b]]&&(a[c[b]]=void 0)}a.processed=1}b=$(app.detailView(a));app.cDetail.css("display","inline-block").html(b);app.app.addClass("detail-view");$(".content.loading").removeClass("loading");a.images?$("#menu-show-images").removeClass("hidden"):$("#menu-show-images").addClass("hidden");$(".btn-back",app.cDetail).on("click",function(){this.hideDetail()});$(".icontags > span").on("click",function(){var a=app.tag().getNameByHtml(this.className);""!=a&&addLoadDataWithFilter("#"+
a)});$(".lower .video a").each(function(a){app.videoPlayer.quit();a=$(this).attr("class");journal.archive.map[a]?(a='app.videoPlayer("#app #video-preview","'+journal.archive.map[a].url+'")',$(this).attr("onclick",a).removeAttr("class")):animation.error(log.FILE_NOT_LOADED+a+log.DOWNLOAD_PROMPT)});$(".lower .voice a").each(function(a){app.audioPlayer.quit();var b=$(this).attr("class");journal.archive.map[b]?(a='app.audioPlayer("#detail .content .voice:eq('+a+') a","'+journal.archive.map[b].url+'")',
$(this).attr("onclick",a).removeAttr("class")):animation.error(log.FILE_NOT_LOADED+b+log.DOWNLOAD_PROMPT)});$("#edit-this, #delete").removeClass("hidden");animation.testAllSubs();return a};
...
a[0];if(!a)return!1;c=app.util.crop(1024,720,c,d);c=app.util.style(c);d=app.resource+a.thumb;d.match(/.(jpg|png)$/)||(d+=".jpg");c&&(c=' style="'+c+'"');void 0!==a.thumb&&(a.thumb='<img src="'+d+'"'+c+">")}},hideDetail:function(){$("#edit-this, #delete").addClass("hidden");animation.testAllSubs();app.cDetail.css("display","none").empty();app.cList.css("display","inline-block");app.app.removeClass("detail-view");app.photos&&app.photos.remove()}};
app.layout=function(){var a=$(window),b=function(){var b=a.height()-110;app.app.height(b);app.contents.height(b)};b();a.on("resize",b)};
app.util={fit:function(a,b,c,d){var f=c<a?c:a,e=d<b?d:b,g=Math.ceil(a/b*e),h=Math.ceil(f/(a/b)),k={};a>b?d>h?(k.width=f,k.height=h):(k.width=g,k.height=e):c>g?(k.width=g,k.height=e):(k.width=f,k.height=h);return k},crop:function(a,b,c,d){d=d||c;var f=Math.ceil(a/b*d),e=Math.ceil(c/(a/b)),g={};a>b?d>e?(g.width=f,g.height=d,g.marginLeft=-((f-c)/2)):(g.width=c,g.height=e,g.marginTop=-((e-d)/2)):a<b&&(c>f?(g.width=c,g.height=e,g.marginTop=-((e-d)/2)):(g.width=f,g.height=d,g.marginLeft=-((f-c)/2)));return g},
...
a=$(".upper > a",app.cDetail);0<a.length&&(app.photos=new app.PhotoViewer(a.find(" > img").clone()),a.on("click",function(a){a.preventDefault();a=$(this).index();app.photos.open(a);return!1}))};app.PhotoViewer=function(a,b){if(!a&&"object"!=typeof a)return!1;this.list=a;this.callback=b||function(){};this.make();this.init()};
app.PhotoViewer.prototype={make:function(){var a=this.list;if(1<a.length)var b=$("<ul>");var c=$('<ul class="swipe-wrap">');a.each(function(a){$("<li>").html(this).appendTo(c);b&&$("<li>").html('<a href="#'+a+'">'+a+"</a>").appendTo(b)});var d=$('<div class="wrap swipe">').html(c),f=$('<div class="control">');f.append('<input type="button" value="Close" class="btn-close"/>');b&&b.css("width",17*a.length).wrap('<div class="pagination"/>').parent().appendTo(f);d.append(f);d.append('<div class="background"></div>');
$('<div id="photoviewer">').html(d).appendTo("body")},init:function(){this.viewer=$("body > div#photoviewer")},bind:function(){function a(a){a=$(window);var c=a.width(),d=a.height();f.each(function(){var a=$(this),e=b.fit(a.context.naturalWidth||a.context.width,a.context.naturalHeight||a.context.height,c,d);a.css(e)})}if(this._bind)return this.swipe.setup(),!1;var b=this,c=this.viewer=$("body > div#photoviewer");this.pagination=$("div.pagination>ul>li",this.viewer);var d=c.find(" > div.swipe");this.swipe=
new Swipe(d[0],{continuous:!1,callback:b.callback,transitionEnd:function(a){b.paging(a)}});$("input.btn-close",c).on("click",function(){b.close()});var f=d.find(" > ul > li > img");a();$(window).on("resize",a);var e=$("div.control",c);f.on("click",function(){e.fadeToggle(200)});d.find(" > ul > li").on("click",function(a){this==a.toElement&&b.close()});this._bind=1},fit:function(a,b,c,d){a=app.util.fit(a,b,c,d);$.browser.msie?(a.marginLeft=-(a.width/2),a.marginTop=-(a.height/2)):(a.marginLeft=-(a.width/
...
app.checkResource=function(){if(0===Object.keys(journal.archive.map).length)animation.error(log.MEDIA_CLEAN_NOT_FOUND+log.DOWNLOAD_PROMPT);else{for(var a=Object.keys(journal.archive.map),b=["images","video","voice"],c=0,d=0,f=journal.archive.data[app.year].length;d!==f;++d)for(var e=journal.archive.data[app.year][d],g=0;g!==b.length;++g)if(e[b[g]])for(var h=0;h<e[b[g]].length;++h){var k=a.indexOf(e[b[g]][h].fileName);-1===k?(++c,e[b[g]].splice(h,1),--h):a.splice(k,1)}app.lostMedia=[];for(d=0;d!==
...
app.cleanResource=function(){0===app.lostMedia.length?animation.error(log.MEDIA_CLEAN_NO_DATA):(animation.log(log.MEDIA_CLEAN_START),getTokenCallback(function(a){$.ajax({type:"GET",url:getDataUrlHeader()+":/children?select=name&top=500&access_token="+a}).done(function(b){var c=b.value;b=[];for(var d=0,f=c.length;d!==f;++d)b.push(c[d].name);for(var e=0,g=0,d=0;d!==lostMedia.length;++d)c=lostMedia[d].substring(0,6),c=-1===b.indexOf(c)?"queue":"data/"+c,c="/drive/root:/Apps/Journal/"+c,c={parentReference:{path:c}},
f=(f=journal.archive.map[lostMedia[d]].id)?"https://api.onedrive.com/v1.0/drive/items/"+f+"?select=id,@content.downloadUrl&access_token="+a:getResourceUrlHeader(!0)+"/"+encodeURI(lostMedia[d])+"/?select=id,@content.downloadUrl&access_token="+a,$.ajax({type:"PATCH",url:f,contentType:"application/json",data:JSON.stringify(c)}).done(function(){}).fail(function(){++g}).always(function(){++e===app.lostMedia.length&&(0<g?animation.log(g+log.MEDIA_CLEAN_FAIL):animation.log(log.MEDIA_CLEAN_SUCCESS),app.lostMedia=
[])})}).fail(function(a,c,d){animation.error(log.MEDIA_CLEAN_GET_FOLDERS_FAIL,d,-1)})}))};
$(document).ready(function(){app.app=$("div#app");app.contents=app.app.find(" > #contents");app.cList=app.app.find(" > #contents > #list");app.cDetail=app.app.find(" > #contents > #detail");app.itemView=_.template($("#list-view").html());app.detailView=_.template($("#detail-view").html());calendar.viewTemplate=_.template($("#calendar-view").html());app.layout();app.initializeApp();archive.itemView=_.template($("#archive-view").html());archive.detailView=_.template($("#archive-detail-view").html())});
window.archive={};archive.data=[];archive.displayId="";archive.isDisplayed=!1;archive.lastLoaded=0;archive.currentDisplayed=-1;archive.confirmName="";
archive.init=function(a){$(a).addClass("spinr");archive.contents=void 0;archive.data=[];archive.confirmName="";getTokenCallback(function(b){animation.log(log.ARCHIVE_START,1);$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/special/approot:/core/"+app.year+":/children?select=id,name,size,createdDateTime,lastModifiedDateTime,@content.downloadUrl&top=500&orderby=lastModifiedDateTime%20desc&access_token="+b}).done(function(a,b,f){a["@odata.nextLink"]&&animation.warn(log.ARCHIVE_TOO_MANY);
animation.log(log.ARCHIVE_END,-1);a=a.value;b=0;for(f=a.length;b!==f;++b){var e=a[b].name;if(("data"===e.substring(0,4)||"_data"===e.substring(0,5))&&".js"===e.substring(e.length-3)&&"data.js"!==e){var g={name:e,id:a[b].id,url:a[b]["@content.downloadUrl"],size:a[b].size,created:Date.parse(a[b].createdDateTime),modified:Date.parse(a[b].lastModifiedDateTime),selected:!1,processed:!1,protect:!1};"_"===e.substring(0,1)&&(g.protect=!0);archive.data.push(g)}}app.audioPlayer.quit();$("#list").empty();$("#detail").empty();
archive.isDisplayed=!0;archive.lastLoaded=0;animation.showMenuOnly("archive");$("#search-new, #search-result").fadeOut();archive.load()}).fail(function(a,b,f){animation.error(log.FILES_NOT_FOUND,f,-1)}).always(function(){$(a).removeClass("spinr")})})};
archive.load=function(){$("#search-result").hide();archive.detail.prototype.hideDetail();$("#list").empty();archive.lastLoaded=0;archive.currentDisplayed=-1;for(var a=0,b=archive.data.length;a!==b;++a)archive.data[a].processed=!1;new archive.list;archive.dataLoaded=!0};
archive.list=function(){var a=this,b=app.cList,c=b.children("ul");!this.contents&&1>c.length&&(b.html('<ul></ul><div class="loadmore"></div>'),this.contents=b.children("ul"),this.loadmore=b.children("div.loadmore"),this.loadmore.on("click",function(){a.load()}),this.load(),b.off("scroll").on("scroll",function(){$(this).scrollTop()>a.contents.height()-b.height()&&0!==$(".loadmore").length&&a.load()}))};
archive.list.prototype={load:function(){var a=archive.data,b=archive.lastLoaded;archive.lastLoaded>=archive.data.length&&(b=archive.lastLoaded=archive.data.length-1);for(a[b].index=b;a=archive.data[b],archive.data[b].created=this.date(a.created),archive.data[b].modified=this.date(a.modified),this.html(a),++b,$("#list").get(0).scrollHeight==$("#list").height()&&b<archive.data.length;);++b>=archive.data.length&&($(".loadmore").remove(),$("#list").append('<li><p class="separator"><span>EOF</span></p></li>'));
archive.lastLoaded=b},date:function(a){if("number"!==typeof a)return"";a=new Date(a);var b=a.getHours(),c=a.getMinutes(),d=a.getFullYear(),f=new Date,e=f.getFullYear(),g=a.getMonth(),h=a.getDate();if(d===e){var k=new Date(d,0,1),e=Math.floor((a-k)/864E5),d=Math.floor((f-k)/864E5);if(e===d)return a=Math.floor((f-a)/6E4),0===a?"Just now":60>a?a+" min":Math.floor(a/60)+" hr";if(e+1===d)d="Yesterday";else switch(k=k.getDay(),f=Math.floor((e-k)/7),e=Math.floor((d-k)/7),d="",e-f){case 1:d="Last ";case 0:d+=
app.weekArray[a.getDay()];break;default:d=app.monthArray[g]+" "+h}}else d=app.monthArray[g]+" "+h;return d+" "+(10>b?"0"+b:b)+":"+(10>c?"0"+c:c)},html:function(a){a=$(archive.itemView(a));a.find(" > a").on("click",function(a){a.preventDefault();animation.hideHiddenIcons();$("#list ul li:nth-child("+(archive.currentDisplayed+1)+") a").removeClass("display");$(this).addClass("display");archive.currentDisplayed!=$(this).parent().index()&&(archive.currentDisplayed=$(this).parent().index(),$("#detail").hide(),
archive.view=new archive.detail);return!1}).on("contextmenu",function(){$(this).toggleClass("change");return!1});a=a.hide();this.contents.append(a.fadeIn(500))}};
archive.detail=function(){var a=archive.data[archive.currentDisplayed];if(a.processed)try{var b=$(archive.detailView(a));app.cDetail.html(b);app.app.addClass("detail-view");a.images||$(".center").hide();$("#detail").fadeIn(500);$(".btn-back",app.cDetail).on("click",function(){this.hideDetail()});return a}catch(d){animation.error(log.ARCHIVE_INVALID_JSON)}else{animation.log(log.CONTENTS_DOWNLOAD_START,1);$("#list").addClass("loading");var c=this;$.ajax({type:"GET",url:a.url}).done(function(b,f,e){animation.log(log.CONTENTS_DOWNLOAD_END,
-1);$("#list").removeClass("loading");b=JSON.parse(e.responseText.substring(e.responseText.indexOf("["))).slice(0,50);for(f=0;f!==b.length;++f)b[f].time.created=edit.getMyTime(b[f].time.created),b[f].time.modified=edit.getMyTime(b[f].time.modified);a.contents=b;a.processed=!0;b=$(archive.detailView(a));app.cDetail.css("display","inline-block").html(b);app.app.addClass("detail-view");$("#detail").fadeIn(500);$(".btn-back",app.cDetail).on("click",function(){c.hideDetail()});$("#archive-restore").removeClass("hidden");
return a}).fail(function(a,b,e){animation.error(log.CONTENTS_DOWNLOAD_TEXT_FAIL,e,-1);c.hideDetail()})}};archive.detail.prototype={htmlSpacialChars:function(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/'/g,"&#039;").replace(/"/g,"&quot;")},hideDetail:function(){app.cDetail.css("display","none").empty();app.cList.css("display","inline-block");app.app.removeClass("detail-view");animation.hideHiddenIcons()}};
...
archive.protect=function(a){getTokenCallback(function(b){for(var c={},d=0,f=0;f!==archive.data.length;++f){var e=archive.data[f];e&&(e.protect?"_"!==e.name.substring(0,1)&&(c[e.id]="_"+e.name):"_"===e.name.substring(0,1)&&(c[e.id]=e.name.substring(1)))}e=Object.keys(c);if(0===e.length)animation.log(log.ARCHIVE_NO_PROTECT_CHANGE),a();else{animation.log(log.ARCHIVE_PROTECT_START,1);for(var f=0,g=e.length;f!==g;++f){var h=e[f];$.ajax({type:"PATCH",url:"https://api.onedrive.com/v1.0/drive/items/"+h+"?select=id&access_token="+
...
archive.remove=function(a){getTokenCallback(function(b){for(var c=0,d=0,f=0,e=0;e!==archive.data.length;++e)archive.data[e]["delete"]&&(archive.data[e].protect?(animation.log(log.ARCHIVE_PROTECT_REMOVE+archive.data[e].name+log.ARCHIVE_PROTECT_REMOVE_END),archive.data[e]["delete"]=!1):++c);if(0===c)animation.log(log.ARCHIVE_NO_SELECTED_REMOVE),a();else for(animation.log(log.ARCHIVE_REMOVE_START,1),e=0;e!==archive.data.length;++e)archive.data[e]["delete"]&&$.ajax({type:"DELETE",url:"https://api.onedrive.com/v1.0/drive/items/"+
archive.data[e].id+"?access_token="+b}).done(function(){}).fail(function(){++d}).always(function(){++f>=c&&(0<d&&animation.error(log.ARCHIVE_REMOVE_FAIL),animation.log(c-d+log.CONTENTS_DOWNLOAD_MEDIA_OF+c+log.ARCHIVE_REMOVE_END,-1),a())})})};
archive.toggle=function(a){var b=!1;$("#list .archive").each(function(c){$(this).children("a").hasClass("change")&&(b=!0,$(this).children("a").toggleClass(a).hasClass(a)?archive.data[c][a]=!0:archive.data[c][a]=!1,$(this).children("a").removeClass("change"))});b||animation.warn(log.ARCHIVE_NO_SELECTED)};archive.selectBelow=function(){var a=archive.currentDisplayed;-1===a&&animation.log(log.ARCHIVE_SELECT_ALL);++a;$("#list .archive").each(function(b){b>=a&&$(this).children("a").addClass("change")})};
archive.reverse=function(){$("#list .archive").each(function(){$(this).children("a").toggleClass("change")})};archive.clear=function(){$("#list .archive").each(function(){$(this).children("a").removeAttr("class")})};archive.quit=function(){archive.isDisplayed&&(archive.isDisplayed=!1,$("#list").empty(),$("#detail").empty(),$("#refresh-media").trigger("click"),$("#search-new, #search-result").fadeIn(),animation.showMenuOnly("menu"))};window.network={};network.percent=0;network.current=0;
network.breakpoint=0;network.interval=0;network.yearFolders=[];network.isAjaxActive=!1;network.timeOut=15E3;
...
function downloadFile(a,b,c){animation.log(log.CONTENTS_DOWNLOAD_START,1);"function"!=typeof c&&(c=function(){});getTokenCallback(function(d){-1===network.yearFolders.indexOf(app.year)?createFolders(function(){app.refresh();c()},3):($("#download").html("&#xf1ce").addClass("spin").removeAttr("onclick").removeAttr("href"),a=a||getCoreDataUrlHeader(!0)+":/content?access_token="+d,$.ajax({type:"GET",url:a}).done(function(a,e,g){window.app.dataLoaded[app.year]=!1;app.addLoadDataWithFilter("",g.responseText);
...
function backupAll(a){getTokenCallback(function(b){animation.log(log.CONTENTS_BACKUP_START);a=a||app.years;network.init(a.length-1);for(var c=0;c!==a.length;++c){var d=new Date,f=d.getMonth()+1,e=d.getDate(),g=d.getFullYear()%100,h=d.getHours(),k=d.getMinutes(),l=d.getSeconds(),d=a[c],f=10>f?"0"+f:f,e=10>e?"0"+e:e,g=10>g?"0"+g:g,h=10>h?"0"+h:h,k=10>k?"0"+k:k,l=10>l?"0"+l:l,f={name:"data_"+f+e+g+"_"+h+k+l+".js"};$.ajax({type:"POST",url:getCoreDataUrlHeader(!1,d)+":/action.copy?access_token="+b,contentType:"application/json",
data:JSON.stringify(f),headers:{Prefer:"respond-async"}}).done(function(){animation.debug(log.CONTENTS_UPLOAD_BACKUP)}).fail(function(a,b,c){"Bad Request"!==c&&(animation.error(log.CONTENTS_UPLOAD_BACKUP_FAIL,c,-1),network.destroy())}).always(function(a,b,c){network.next()})}})}
...
function getCoverPhoto(a,b,c,d){var f="https://itunes.apple.com/search?output=json&lang=1&limit=1&media=music&entity=song,album,musicArtist&term=";"number"==typeof d&&(d=edit.mediaName(d));"movie"==d?f="https://itunes.apple.com/search?output=json&lang=1&limit=1&media=movie&entity=movieArtist,movie&term=":"book"==d&&(f="https://itunes.apple.com/search?output=json&lang=1&limit=1&media=ebook&entity=ebook&term=");$.ajax({url:f+b,dataType:"jsonp",success:function(b){var d=b.results[0];if(void 0==d)animation.warn(log.COVER_PHOTO_FAIL),
animation.invalid(a+"input");else{animation.debug(log.COVER_PHOTO_FOUND);b=d.artistName;var f=d.trackName,d=d.artworkUrl100;c&&($(a+".title").val(f),$(a+".desc").val(b));$(a+".thumb").attr("src",d)}}})}
...
function createFolders(a,b){getTokenCallback(function(c){var d=0,f=!1,e=["https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/core:/","https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/data:/","https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/resource:/"],g={name:app.year.toString(),folder:{}};network.init(b);for(var h=0;h!==e.length;++h)$.ajax({type:"POST",url:e[h]+"children?access_token="+c,contentType:"application/json",data:JSON.stringify(g)}).done(function(){network.next();++d===
e.length&&(network.yearFolders.push(app.year),a(c))}).fail(function(b){409==b.status?(network.next(),++d===e.length&&(network.yearFolders.push(app.year),a(c))):(network.destroy(),f||animation.error(log.CONTENTS_UPLOAD_REGISTER_FAIL),f=!0)})})}
function removeFileById(a,b,c,d){getTokenCallback(function(f){$.ajax({type:"DELETE",url:"https://api.onedrive.com/v1.0/drive/items/"+a+"?access_token="+f}).done(function(){"function"===typeof b&&b()}).fail(function(){"function"===typeof c&&c()}).always(function(){"function"===typeof d&&d()})})}
window.bulb=function(){function a(a){getTokenCallback(function(b){var d=bulb.getID(a);$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/items/"+d+"/content?access_token="+b}).done(function(b,d,g){b=g.responseText;b=b.replace(/\r*\n/g," ");bulb.setRawContent(a,b);bulb.extractRawContent(a);bulb.mergeIntoArchive(a);animation.log(++f+log.BULB_PROCESSED_LEFT+c)}).always(function(){bulb.decrementTotalBulbs();0>=c&&app.finishMergingBulbs()})})}var b={},c=0,d=0,f=0;return{isProcessing:!1,initFetchData:function(b){bulb.isProcessing?
animation.error(log.BULB_STILL_BUSY):downloadFile(void 0,void 0,function(){animation.log(log.BULB_FETCH_START);bulb.isProcessing=!0;if(void 0==b){var c=getTokenFromCookie();b=getBulbUrlHeader()+":/children?select=id,name,size,@content.downloadUrl&top=500&access_token="+c;bulb.totalBulbs=0}$.ajax({type:"GET",url:b}).done(function(b){b=b.value;bulb.clearData();bulb.setTotalBulbs(b.length);if(0===b.length)animation.log(log.BULB_NO_CONTENT_AVAILABLE),bulb.isProcessing=!1;else{animation.log(log.BULB_FETCH_CONTENT_START);
for(var c=0,d=b.length;c!=d;++c){var e={id:b[c].id,url:b[c]["@content.downloadUrl"]},f=bulb.getTimeFromEpoch(b[c].name);bulb.setData(f,e);a(f)}}}).fail(function(){bulb.isProcessing=!1})})},setdata:function(a,c){b[a]=c},getTimeFromEpoch:function(a){var b=parseInt(a.substr(0,2)),c=parseInt(a.substr(2,2)),d=2E3+parseInt(a.substr(4,2)),f=parseInt(a.substr(7,2)),m=parseInt(a.substr(9,2));a=parseInt(a.substr(11,2));return(new Date(d,b-1,c,f,m,a)).getTime()},extractRawContent:function(a){var c=/(.+)@(https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*))(.*)/g.exec(b[a].contentRaw);
c&&(b[a].website=c[2],b[a].content=c[1]+c[c.length-1]);var d=/(.+)#\[(-?[0-9]+\.[0-9]+),(-?[0-9]+\.[0-9]+)\](.*)/,c=b[a].contentRaw;if(d=d.exec(c))b[a].location={name:d[2]+","+d[3],lat:d[2],"long":d[3]},b[a].content=d[1]+d[d.length-1];else if(d=/(.+)#\[(.+),(-?[0-9]+\.[0-9]+),(-?[0-9]+\.[0-9]+)\](.*)/g,d=d.exec(c))b[a].location={name:d[2],lat:d[3],"long":d[4]},b[a].content=d[1]+d[d.length-1]},mergeIntoArchive:function(a){app.isBulbExist(a)?(b[a].isMerged=!0,b[a].isUploaded=!0):app.addBulb(b[a],a)},
setIsMerged:function(a){b[a].isMerged=!0},setTotalBulbs:function(a){d=c=a},decrementTotalBulbs:function(){--c},getTotalBulbs:function(){return c},getTotalAvailableBulbs:function(){return d},getMergedBulbCounter:function(){return f},setData:function(a,c){b[a]=c},clearData:function(){b={}},removeUploadedBulbs:function(){for(var a in b)b.hasOwnProperty(a)&&b[a].isMerged&&removeFileById(b[a].id,void 0,void 0,function(){0===--f&&(bulb.isProcessing=!1,animation.log(log.BULB_FETCH_FINAL_END))})},getBulbData:function(){return b},
getID:function(a){return b[a].id},setRawContent:function(a,c){b[a].contentRaw=c}}}();window.stats={};stats.oldValue="";stats.entries={};stats.options={startDay:0,endDay:366,isIncludingTitles:!0,isIncludingTags:!1,viewAsMonth:!1};stats.eachDay=[];stats.monthVal=[];stats.isLeapYear=!1;stats.isEditing=-1;stats.isGraphDisplayed=!1;
...
"return",function(){var a=$(this).val(),a=stats.simplifyEntry(a);0===a.length?($(this).effect("highlight",{color:"#000"}),animation.debug(log.STATS_ENTRY_EMPTY_STRING)):(stats.entries[a]?($(this).effect("highlight",{color:"#000"}),animation.debug(log.STATS_ENTRY_ALREADY_EXIST)):($(this).effect("highlight",{color:"#ddd"}),stats.addEntry(a),$(this).val(""),$(this).focus()),$(this).select())});stats.initTable();animation.showMenuOnly("stats");$("#stats-options li.checkbox").each(function(){$(this).click(function(){$(this).toggleClass("checked");
...
animation.error(log.STATS_ENTRY_ALREADY_EXIST),$(this).val(stats.oldValue);else{$(this).parent().parent().effect("highlight",{color:"#ddd"});var b=$(this).parent().parent().index()+1;delete stats.entries[stats.oldValue];stats.addEntry(a,b);stats.oldValue=a;this.blur()}else 27===a.keyCode&&this.blur()}).delegate("th","click",function(){if(0!==$("tbody tr").length){var b=$(this).hasClass("desc"),c=$(this).index(),e=[];$("tbody tr").each(function(){var a,b;$(this).children("td").each(function(d){0===
d&&(a=$(this).children("input").val());d===c&&(b=0===d?a:$(this).html())});e.push({key:a,value:b})});stats.initTable();b?($("th").eq(c).addClass("asce"),0===c?e.sort(function(a,b){return a.value.localeCompare(b.value)}):e.sort(function(a,b){return a.value-b.value})):($("th").eq(c).addClass("desc"),0===c?e.sort(function(a,b){return b.value.localeCompare(a.value)}):e.sort(function(a,b){return b.value-a.value}));for(a=0;a!==Object.keys(e).length;++a)stats.addEntry(e[a].key)}});$("#contents").fadeOut(400,
...
stats.quit=function(){stats.removeAll();$("#query").fadeIn();$("#stats-query").fadeOut().unbind("keyup");$("#stats-options li.checkbox").each(function(){$(this).unbind("click")});$(".stats").removeClass("stats");$("#stats-table").undelegate("td","mouseover mouseleave contextmenu").undelegate("input","focusin focusout keyup").delegate("th","contextmenu");$("#stats-pane").fadeOut(400,function(){$("#contents").fadeIn();animation.showMenuOnly();app.refresh()})};
stats.addEntry=function(a,b){var c,d=stats.getResult(a);stats.entries[a]=d;var f=Array(12),e=0,g=0;for(c=0;c!==stats.monthVal.length;++c){for(var h=f[c]=0;h!==stats.monthVal[c];++h,++e)d[e]&&(f[c]+=d[e]);g+=f[c]}d="<td><input type='text' class='edit' autocomplete='off' onclick='this.select()' value='"+a+"' /></td>";for(c=0;c!==f.length;++c)d+="<td>"+f[c]+"</td>";d+="<td>"+g+"</td>";b?$("tbody tr:nth-child("+b+") input").parent().parent().html(d).addClass("fadein"):$("<tr>"+d+"</tr>").appendTo("tbody").addClass("fadein");
...
stats.getYearSum=function(){for(var a=0,b=0,c=0,d=0,f=0,e=0,g=0;g!==journal.archive.data[app.year].length;++g){var h=journal.archive.data[app.year][g];if(stats.isInTimeRange(h.time.created)){a+=h.text.chars||0;b+=h.text.lines||0;if(h.time.end){var k=(h.time.end-h.time.start)/6E4;isNaN(k)||(c+=k)}h.images&&(d+=h.images.length);h.video&&(f+=h.video.length);h.voice&&(e+=h.voice.length)}}$("#total-char").text(a);$("#total-line").text(b);a=c%60;10>a&&(a="0"+a);$("#total-time").text(Math.floor(c/60)+":"+
a);$("#total-image").text(d);$("#total-video").text(f);$("#total-voice").text(e)};
stats.getResult=function(a){a=a.split("|");var b;b=stats.isLeapYear?Array(366):Array(365);for(var c=0;c!==journal.archive.data[app.year].length;++c){var d=[],f=journal.archive.data[app.year][c],e=f.time.created;if(stats.isInTimeRange(e))for(e=stats.getDayNumber(e),d.push(f.text.body),this.options.isIncludingTags&&d.push(f.tags),this.options.isIncludingTitles&&d.push(f.title),f=0;f!==d.length;++f){var g=d[f];if(g)for(var h=0;h!==a.length;++h){var k=a[h];b[e]||(b[e]=0);b[e]+=(g.match(new RegExp(k,"gi"))||
...
stats.showGraph=function(a){var b;stats.isGraphDisplayed=!0;var c=[],d=[],f;if(a)d=app.monthArray,$("#stats-table tbody tr").each(function(){var a=[];$(this).children("td").each(function(b){0===b?f=$(this).children("input").val():13>b&&a.push($(this).html())});c.push({name:f,data:a})});else{var e;a=0;for(e=Object.keys(stats.entries);a!==e.length;++a)if(f=e[a],c.push({name:e[a],data:stats.entries[f]}),0===a){var g=stats.entries[f];for(b=0;b!==g.length;++b)void 0!=g[b]&&d.push(stats.eachDay[b])}}for(a=
0;a!==Object.keys(c).length;++a){e=c[a].data;g=[];for(b=0;b!==e.length;++b)void 0!=e[b]&&g.push(e[b]);c[a].data=g}d={chart:{backgroundColor:"#f3f3f3"},title:{text:"Stats for this year",x:-20},subtitle:{text:"Collected from "+$("#total-char").html()+" chars in "+$("#total-entry").html()+" entries",x:-20},xAxis:{categories:d},yAxis:{min:0,plotLines:[{value:0,width:1,color:"#808080"}],title:{text:"Times"}},legend:{layout:"vertical",align:"right",verticalAlign:"middle",borderWidth:0},series:c,exporting:{enabled:!1,
filename:"Journal Analysis "+app.year}};$("#graph").fadeIn().highcharts(d);$("#action-stats .hidden").removeClass("hidden");animation.testAllSubs()};stats.hideGraph=function(){stats.isGraphDisplayed=!1;$("#graph").fadeOut(function(){$(this).html("")});$("#action-stats .hidden-icon").addClass("hidden");animation.testAllSubs()};stats.toggleYearView=function(){stats.hideGraph();stats.options.viewAsMonth=!stats.options.viewAsMonth;stats.showGraph(stats.options.viewAsMonth)};
window.calendar=function(){var a=[[15,"bulb-3"],[7,"bulb-2"],[3,"bulb-1"],[1,"bulb-0"]],b={},c={},d=function(b){for(var c=0;c!==a.length;++c)if(b>a[c][0])return a[c][1];return""},f=function(a,e,f){a=new Date(a);var l=a.getMonth(),m=a.getDate(),n=app.monthArray[l]+" "+m;a=$("#month-"+l+" .day-"+m);e&&a.addClass("article");a.addClass(d(f)).css({article:e,bulb:f}).prepend("<div class='bubble'>"+n+"<p class='article-no'>"+e+"</p><p class='bulb-no'>"+f+"</p></div>");b[l]=(b[l]||0)+(e||0);c[l]=(c[l]||0)+
(f||0);e||f?a.attr("href","javascript:;").click(function(){calendar.shrink(n);var a;a="@"+(9>l?"0"+(l+1):l+1);a+=10>m?"0"+m:m;a+=app.year%100;app.addLoadDataWithFilter(a)}):a.removeAttr("href").off("click")},e=function(){for(var a=0;12!=a;++a){var d=b[a]||0,e=c[a]||0;$("#month-"+a).prepend("<div class='bubble'><p class='article-no'>"+d+"</p><p class='bulb-no'>"+e+"</p></div>").click(function(){calendar.shrink(app.monthArray[a]);var b;b="@"+(9>month?"0"+(month+1):month+1);b+=app.year%100;app.addLoadDataWithFilter(b)})}};
return{viewTemplate:void 0,initView:function(){var a=new Date,b=[];a.setMonth(0,0);for(var c=[],d=0;d<(a.getDay()+1)%7;++d)c.push(0);a.setFullYear(a.getFullYear()+1);for(var e=1;12>=e;++e){a.setMonth(e,0);for(d=1;d<=a.getDate();++d)c.push(d);for(;42>c.length;)c.push(0);b.push(c);c=[];for(d=0;d<(a.getDay()+1)%7;++d)c.push(0)}a=$(calendar.viewTemplate({days:b,monthName:app.monthArray}));$("#data-calendar").html(a)},showContent:function(a){this.clear();a=journal.archive.data[app.year];for(var b=a.length,
c=(new Date(app.year,0,1)).getTime(),d=0,m=0,n=0;n!==b;++n){var p=a[n],q=p.time.start||p.time.created;if(864E5<=q-c||0>q-c)f(c,d,m),m=d=0,c=new Date(q),c=(new Date(app.year,c.getMonth(),c.getDate())).getTime();p.contentType===app.contentType.BULB?++m:++d}e();a=new Date;if(app.year===a.getFullYear())for(a=a.getMonth()+1;12>a;++a)$("#month-"+a).addClass("hidden");a=new Date;app.year===a.getFullYear()&&$("#month-"+a.getMonth()+" .day-"+a.getDate()).addClass("today")},clear:function(){$(".calendar-table .day").removeClass("article bulb-0 bulb-1 bulb-2 bulb-3 bulb-4 bulb-5 bulb-6 bulb-7");
b={};c={};$(".calendar-table").find(".bubble").remove();$(".month-cell").removeClass("hidden");$(".today").removeClass("today")},shrink:function(a){a=a||"";$("#calendar-thumbnail").text(a);$("#data-calendar").addClass("minimized");$("#list").addClass("extended")},expand:function(){$("#data-calendar").removeClass("minimized");$("#list").removeClass("extended")}}}();
