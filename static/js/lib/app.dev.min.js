...
window.calendar=function(){function a(a){for(var d=0;d!==b.length;++d)if(a>b[d][0])return b[d][1];return""}var b=[[20,"bulb-7"],[15,"bulb-6"],[10,"bulb-5"],[7,"bulb-4"],[5,"bulb-3"],[3,"bulb-2"],[2,"bulb-1"],[1,"bulb-0"]];return{viewTemplate:void 0,initView:function(){var a=new Date,b=[];a.setMonth(0,0);for(var e=[],f=0;f<(a.getDay()+1)%7;++f)e.push(0);a.setFullYear(a.getFullYear()+1);for(var g=1;12>=g;++g){a.setMonth(g,0);for(f=1;f<=a.getDate();++f)e.push(f);for(;42>e.length;)e.push(0);b.push(e);
e=[];for(f=0;f<(a.getDay()+1)%7;++f)e.push(0)}a=$(calendar.viewTemplate({days:b,monthName:app.monthArray}));$("#data-calendar").html(a)},showContent:function(b){b=journal.archive.data[app.year];for(var d=b.length,e=(new Date(app.year,0,1)).getTime(),f=!1,g=0,h=0;h!==d;++h){var k=b[h],l=k.time.start||k.time.created;if(864E5<=l-e||0>l-e)e=new Date(e),e=$(".calendar-table .month-"+e.getMonth()+" .day-"+e.getDate()),f&&e.addClass("article"),e.addClass(a(g)),f=!1,g=0,l=new Date(l),e=(new Date(app.year,
l.getMonth(),l.getDate())).getTime();k.contentType===app.contentType.BULB?++g:f=!0}},clear:function(){$(".calendar-table .day").removeClass("article bulb-0 bulb-1 bulb-2 bulb-3 bulb-4 bulb-5 bulb-6 bulb-7")}}}();
