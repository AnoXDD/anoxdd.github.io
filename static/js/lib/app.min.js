...
animation.log=function(a,b,c){var d=(new Date).getTime(),f;f="";1===b?f="start ":-1===b&&(0>--animation.indent&&(animation.indent=0),f="end ");0<animation.indent&&(f+="indent-"+animation.indent);c=c||0;var e;switch(c){case 0:f='<p class="'+f+'" id='+d+">"+a+"</p>";e="#feedback";break;case 1:f="<p id="+d+">"+a+"</p>";e="#errors";$(e).empty();break;case 2:f='<p class="'+f+' warning" id='+d+">"+a+"</p>";e="#feedback";break;default:f='<p class="'+f+'" id='+d+">"+a+"</p>",e="#feedback"}$(f).prependTo(e).on("contextmenu",
function(){$(e).fadeOut(200,function(){$(this).empty();$(this).fadeIn(0)});return!1}).mousedown(function(){$(this).trigger("contextmenu");$(this).fadeOut(200,function(){$(this).remove()})});switch(c){case 1:a="[ERR] "+a;break;case 2:a="[!!!] "+a}setTimeout(function(){$("#"+d).trigger("mousedown")},1E4);console.log("From user log: \t"+new Date+": "+a);1===b&&++animation.indent};
...
[])})}).fail(function(a,c,d){animation.error(log.MEDIA_CLEAN_GET_FOLDERS_FAIL,d,-1)})}))};$(document).ready(function(){app.app=$("div#app");app.contents=app.app.find(" > #contents");app.cList=app.app.find(" > #contents > #list");app.cDetail=app.app.find(" > #contents > #detail");app.itemView=_.template($("#list-view").html());app.detailView=_.template($("#detail-view").html());app.layout();app.initializeApp();archive.itemView=_.template($("#archive-view").html());archive.detailView=_.template($("#archive-detail-view").html())});
