...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var d=$jscomp.checkStringArgs(this,a,"startsWith");a+="";for(var e=d.length,f=a.length,g=Math.max(0,Math.min(c|0,d.length)),k=0;k<f&&g<e;)if(d[g++]!=a[k++])return!1;return k>=f}},"es6-impl","es3");$jscomp.polyfill("Array.prototype.entries",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return[a,c]})}},"es6-impl","es3");window.animation={};
...
[];for(var e=["video","voice"],f=0;f!==e.length;++f){var g;if("video"===e[f])g=edit.videos;else if("voice"===e[f])g=edit.voices;else break;if(d[e[f]])for(c=0;c!==d[e[f]].length;++c){var k=d[e[f]][c].fileName;journal.archive.map[k]&&g.push({name:k,title:d[e[f]][c].title,size:journal.archive.map[k].size,id:journal.archive.map[k].id,resource:!0,change:!1})}}console.log(Object.keys(d));var h=$(edit.editView(d));$("#search-new, #search-result").fadeOut();$("#contents").fadeOut(400,function(){var a;$("#edit-pane").html(h).fadeIn();
...
edit.addMediaFromQueue=function(){$("#return-lost-media").removeAttr("onclick");animation.log(log.QUEUE_START,1);network.init(1);edit.photo(!0,function(){network.next();getTokenCallback(function(a){$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/queue:/children?select=id,name,size,@content.downloadUrl&access_token="+a}).done(function(a,c,d){var e;a=a.value;for(var f=d=c=0,g=a.length;f!==g;++f){var k=a[f].id,h=a[f].size,l=a[f].name,m=a[f]["@content.downloadUrl"];e=l.substring(l.length-
4).toLowerCase();var k={id:k,name:l,title:l.substring(0,l.length-4),url:m,size:h,resource:!1,change:!0},n=!0;if(".mp4"===e){for(e=0;e!==edit.videos.length;++e)if(edit.videos[e].size===h){n=!1;break}n&&(++d,edit.videos.push(k),edit.addMedia(-1,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}else if(".mp3"===e||".wav"===e){for(e=0;e!==edit.voices.length;++e)if(edit.voices[e].size===h){n=!1;break}n&&(++c,edit.voices.push(k),edit.addMedia(-3,{fileName:l,url:m,title:l.substring(0,l.length-4)}))}}edit.playableSetToggle();
...
size:journal.archive.map[g].size,url:journal.archive.map[g].url,resource:!0,change:!1}):(c.splice(f--,1),localStorage.images=JSON.stringify(c))}edit.getDate(function(a){animation.log(log.EDIT_PANE_IMAGES_START+a+log.EDIT_PANE_IMAGES_START_END,1);e(a)})}}}else animation.error(log.EDIT_PANE_IMAGES_ALREADY_LOADED)};
edit.photoSave=function(a){if(0==edit.photos.length)a();else{var b=[],c=[];edit.getDate(function(d){$("#attach-area .images div").each(function(){for(var a=0;a!==edit.photos.length;++a)if($(this).children("img").attr("src")===edit.photos[a].url){edit.photos[a].change=$(this).hasClass("change");break}});for(var e=0;e!==edit.photos.length;++e){var f=edit.photos[e].name,g=edit.photos[e].id,k=edit.photos[e].resource;edit.photos[e].change&&(edit.photos[e].change=!1,b.push({name:f,id:g,resource:!k}))}var h=
"/drive/root:/Apps/Journal/resource/"+app.year,l="/drive/root:/Apps/Journal/data/"+app.year+"/"+d,m=0;0!==b.length?getTokenCallback(function(e){animation.log(log.EDIT_PANE_IMAGES_SAVE_START,1);for(var f=0;f!==b.length;++f){var g;g=b[f].name;var k="https://api.onedrive.com/v1.0/drive/items/"+b[f].id+"?select=id,name,size,@content.downloadUrl&access_token="+e;b[f].resource?(g=d+((new Date).getTime()+f)+g.substring(g.length-4),g={name:g,parentReference:{path:h}}):g={parentReference:{path:l}};$.ajax({type:"PATCH",
url:k,contentType:"application/json",data:JSON.stringify(g)}).done(function(a,c,d){c=a.id;d=a.name;for(var e=0;e!==edit.photos.length;++e)edit.photos[e].id==c&&(edit.photos[e].success=!0,edit.photos[e].name=d,journal.archive.map[a.name]={url:a["@content.downloadUrl"],size:a.size,id:a.id});animation.debug(++m+log.EDIT_PANE_IMAGES_OF+b.length+log.EDIT_PANE_IMAGES_TRASNFERRED)}).fail(function(a,b,c){++m;animation.error(log.EDIT_PANE_TRANSFERRED_FAILED+log.SERVER_RETURNS+c+log.SERVER_RETURNS_END);animation.warning("#add-photo")}).always(function(d,
...
var f;"clear-day"===e||"clear-night"===e?f="w01":"cloudy"===e||"partly-cloudy-day"===e||"partly-cloudy-night"===e?f="w02":"rain"===e?f="w03":"snow"===e||"sleet"===e?f="w04":"wind"===e&&(f="w06");f?(animation.log(log.EDIT_PANE_WEATHER_END,-1),$("#attach-area .icontags ."+f).trigger("click")):animation.log(log.EDIT_PANE_WEATHER_END_FAIL+a.summary+log.EDIT_PANE_WEATHER_END_FAIL_END,-1)}))};
...
b.length;f!==g;++f){var k=b[f].id,h=b[f].size,l=b[f].name,m=b[f]["@content.downloadUrl"],n=l.substring(l.length-4).toLowerCase(),k={id:k,name:l,title:l.substring(0,l.length-4),url:m,size:h,resource:!1,change:!0};switch(a){case 1:if(".mp4"!==n)continue;break;case 3:if(".mp3"!==n&&".wav"!==n)continue}for(var n=!0,p=0;p!==c.length;++p)if(c[p].size===h){n=!1;break}if(n)switch(c.push(k),animation.log(edit.mediaName(a).capitalize()+log.EDIT_PANE_PLAYABLE_FILE+l+log.EDIT_PANE_PLAYABLE_FILE_ADDED),a){case 1:edit.addMedia(-1,
...
return a},f=function(a){animation.indent=0;animation.debug(log.CONTENTS_RELOADED);animation.testAllSubs();console.log("==================Force loaded==================");$("#list").empty();app.lastLoaded=0;app.lastQualified=-1;app.displayedChars=0;app.displayedLines=0;app.displayedNum=0;app.displayedTime=0;app.currentDisplayed=-1;app.command=a;app.highlightWords=[];$("#query").val(a);$("#total-displayed").text(app.displayedNum);$("#total-char").text(app.displayedChars);$("#total-line").text(app.displayedLines);
...
edit.sortArchive(),edit.removeDuplicate(),delete app.yearQueue[app.year]);var a=e();if(0<a.length){animation.log(log.DATA_MOVED_TO_OTHER_YEAR+a.join(", ")+log.DATA_MOVED_TO_OTHER_YEAR_END);for(var b=0;b!==a.length;++b)-1===app.years.indexOf(a[b])&&app.years.push(a[b]);app.years.sort()}},k=function(a,b){console.log("app.loadScript(): data.length = "+a.length);var c="",d;for(d=0;d!==a.length&&"["!=a[d];++d)c+=a[d];(c=parseInt(c))&&(app.version[app.year]=c);journal.archive.data[app.year]=app.updateData(JSON.parse(a.substr(d)));
b()},h=function(a){$("#total-entry").text(journal.archive.data[app.year].length);new app.list(a);app.dataLoaded[app.year]=!0};return{resource:"resource/",monthArray:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekArray:"Sun Mon Tue Wed Thu Fri Sat".split(" "),year:(new Date).getFullYear(),years:[],yearQueue:{},yearChange:{},lastLoaded:0,currentDisplayed:-1,displayedNum:0,displayedLines:0,displayedChars:0,displayedTime:0,lastQualified:-1,pageLoaded:1,preloadedTags:[],command:"",highlightWords:[],
isFunction:!0,lostMedia:[],entryLoadLimit:10,dataLoaded:{},lastUpdated:{},version:{data:2},contentType:{BULB:1},initializeApp:function(){showLoginButton();app.preloadedTags.push("%photo","%video","%music","%voice","%book","%movie","%place","%weblink");for(var e=app.tag().getIconsInName(),f=0;f!=e.length;++f)app.preloadedTags.push("#"+e[f]);a(this);b();c();$("#year").effect("slide",{direction:"up"});app.getYears();d();animation.testCacheIcons();animation.testAllSubs();calendar.initView()},addLoadDataWithFilter:function(a,
b){if(""==b)animation.error(log.LOAD_DATA_FAIL+log.NO_CONTENT),animation.deny("#refresh-media");else{if(void 0==b&&(journal.archive.data[app.year]||(journal.archive.data[app.year]=[]),g(),0===journal.archive.data[app.year].length)){animation.warn(log.LOAD_DATA_FAIL+log.NO_ARCHIVE);animation.deny("#refresh-media");return}var c=$("#search-result");c.hide();app.detail.prototype.hideDetail();animation.testAllSubs();!app.dataLoaded[app.year]&&b&&(animation.debug(log.CONTENTS_NEW+b.length+log.CONTENTS_NEW_END),
console.log("addLoadDataWithFilter(): data.length = "+b.length),k(b,function(){h(a)}),edit.saveDataCache());f(a);h(a);map.show();c.fadeIn(500)}},refresh:function(){app.addLoadDataWithFilter("")},updateData:function(a){app.version[app.year]||(app.version[app.year]=1);if(app.version[app.year]!==app.version.data)switch(animation.debug(log.CONTENTS_UPGRADING),app.version[app.year]){case 1:for(var b=0;b!==a.length;++b){var c=a[b].iconTags;c&&app.tag().getIconsInNameByVal(c).join("|");delete a[b].icontags;
delete a[b].textTags}app.version[app.year]=2}app.version[app.year]>app.version.data&&(app.version[app.year]=app.version.data);return a},getYears:function(){animation.log(log.GET_YEARS_START);getTokenCallback(function(a){$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/core:/children?select=name,createdBy&orderby=name&access_token="+a}).done(function(a){a=a.value;app.years=[];for(var b=0;b!==a.length;++b){var c=a[b].name;parseInt(c)==c&&(c=parseInt(c),app.years.push(c),
network.yearFolders.push(c))}app.user=a[0].createdBy.user.displayName;$("#username").html(app.user);-1===app.years.indexOf((new Date).getFullYear())&&app.years.push((new Date).getFullYear());backupAll();animation.testYearButton();animation.log(log.GET_YEARS_END)}).fail(function(a,b,c){animation.error(log.GET_YEARS_FAIL,c);app.getYears()})})},yearUpdateTry:function(a){app.year=a;0===app.years.length&&app.years.push(app.year);journal.archive.data[a]?app.yearUpdate(a):downloadFile(void 0,!0)},yearUpdate:function(){app.refresh();
animation.testYearButton();animation.debug(log.YEAR_SWITCHED_TO+app.year)},prev:function(a){if(network.isAjaxActive)animation.warn(log.NETWORK_WORKING);else{var b=app.years.indexOf(app.year);-1===b?app.yearUpdateTry((new Date).getFullYear()):(a?b=0:--b,app.yearUpdateTry(app.years[b]))}},next:function(a){if(network.isAjaxActive)animation.warn(log.NETWORK_WORKING);else{var b=app.years.indexOf(app.year);-1===b?app.yearUpdateTry((new Date).getFullYear()):(a?b=app.years.length-1:++b,app.yearUpdateTry(app.years[b]))}},
updateLastUpdated:function(a){a=parseInt(a)||(new Date).getTime();app.lastUpdated[app.year]=a;app.year===(new Date).getFullYear()&&(localStorage.lastUpdated=(new Date).getTime());app.readLastUpdated()},readLastUpdated:function(){var a=app.lastUpdated[app.year];a?a=archive.list.prototype.date(a):app.year===(new Date).getFullYear()?localStorage.lastUpdated?(a=parseInt(localStorage.lastUpdated),app.lastUpdated[app.year]=a,a=archive.list.prototype.date(a)):a="N/A":a="N/A";$("#last-updated").html(a)},
isBulbExist:function(a){},addBulb:function(a,b){var c=a.content||a.contentRaw,c={contentType:app.contentType.BULB,time:{created:b},text:{body:c,chars:c.length}};a.location&&(c.place={latitude:a.location.lat,longitude:a.location["long"]},c.place.title=a.location.name||"");a.website&&(c.weblink={url:a.website});journal.archive.data[app.year].push(c);$("#year").addClass("change");bulb.setIsMerged(b)},finishMergingBulbs:function(){animation.log(log.BULB_FETCH_END+(bulb.getTotalAvailableBulbs()-bulb.getMergedBulbCounter()));
edit.removeDuplicate();edit.sortArchive();app.refresh();bulb.isProcessing=!1;uploadFile(void 0,function(){animation.log(log.BULB_REMOVE_MERGED_START);bulb.removeUploadedBulbs()})}}}();
app.list=function(a){var b=this;journal.total=journal.archive.data[app.year].length;var c=app.cList,d=c.children("ul");!this.contents&&1>d.length&&(c.html('<ul></ul><div class="loadmore"></div>'),this.contents=c.children("ul"),this.loadmore=c.children("div.loadmore"),this.loadmore.on("click",function(){b.load(a)}),this.load(a),c.off("scroll").on("scroll",function(){$(this).scrollTop()>b.contents.height()-c.height()&&0!=$(".loadmore").length&&b.load(app.command)}))};
app.list.prototype={queryCache:{},load:function(a){var b=journal.archive.data[app.year],c=app.lastLoaded,d=app.lastQualified;app.lastLoaded>=journal.archive.data[app.year].length&&(c=app.lastLoaded=journal.archive.data[app.year].length-1);b[c].index=c;a=this.processFilter(a);for(var e=0;e<app.entryLoadLimit&&c<journal.total;++e,++c){if(this.qualify(b[c],a)){if(this.html(journal.archive.data[app.year][c]),d=c,++app.displayedNum,app.displayedChars+=b[c].text.chars||0,app.displayedLines+=b[c].text.lines||
0,b[c].time.end){var f=parseInt((b[c].time.end-b[c].time.start)/6E4);isNaN(f)||(app.displayedTime+=f)}}else this.htmlEmpty();$("#list").get(0).scrollHeight==$("#list").height()&&(e=0)}--c;$("#search-result").hide().fadeIn(500);$("#total-displayed").text(app.displayedNum);$("#total-char").text(app.displayedChars);$("#total-line").text(app.displayedLines);$("#total-time").text(app.displayedTime);++c>=journal.total&&($(".loadmore").remove(),$("#list").append('<li><p class="separator"><span>EOF</span></p></li>'));
app.lastQualified=d;app.lastLoaded=c},processFilter:function(a){if(!a)return[];for(;-1!=a.search("  ");)a=a.replace("  "," ");var b=[];a=a.toLowerCase().split(" ");for(var c=0,d=a.length;c<d;++c){for(var e=a[c].split("|"),f={tags:[],attachments:[],keywords:[]},g=0,k=e.length;g<k;++g){var h=e[g];"#"===h[0]?f.tags.push(h.substr(1)):"%"===h[0]?f.attachments.push(h.substr(1)):"@"===h[0]?f.timeRange=h.substr(1):(f.keywords.push(h),app.highlightWords.push(h))}b.push(f)}return b},qualify:function(a,b){for(var c=
function(a,b){for(var c=0;c<a.length;++c)if(-1!==b.indexOf(a[c]))return!0;return!1},d=(a.tags||"").split("|"),e=app.tag().content(a.attachments||0),f=a.time.created,g=0;g<b.length;++g){var k=b[g];if(!(this.isInRange(k.timeRange||"",f)||c(d,k.tags)||c(e,k.attachments))){for(var h=0;h<k.keywords.length&&!(a.title&&a.title.match(new RegExp(k.keywords[h],"i"))||a.text.body.match(new RegExp(k.keywords[h],"i")));++h);if(h===k.keywords.length)return!1}}return!0},date:function(a,b){var c=new Date(a),d=c.getHours(),
e=c.getMinutes(),e=10>e?"0"+e:e,d=10>d?"0"+d:d;if(b)return d+":"+e;var f=c.getFullYear(),g=new Date,k=g.getFullYear(),h=c.getMonth(),l=c.getDate();if(f===k)if(k=new Date(f,0,1),f=Math.floor((c-k)/864E5),g=Math.floor((g-k)/864E5),f===g)g="Today";else if(f+1===g)g="Yesterday";else switch(k=k.getDay(),f=Math.floor((f-k)/7),k=Math.floor((g-k)/7),g="",k-f){case 1:g="Last ";case 0:g+=app.weekArray[c.getDay()];break;default:g=app.monthArray[h]+" "+l}else g=app.monthArray[h]+" "+l;return g+" "+d+":"+e},html:function(a,
b){a.summary=a.text.ext||a.text.body.substr(0,50);a.isBulb=0;if(a.contentType)a.contentType===app.contentType.BULB&&(a.ext="",a.isBulb=1);else{switch(!b&&a.attachments&1?1:a.coverType){default:a.type="text";a.ext="";break;case 1:a.type="photo";a.ext=this.thumb(a,"images");break;case 2:a.type="video";a.ext=this.thumb(a,"video");break;case 3:a.type="music";a.ext=this.thumb(a,"music");break;case 4:a.type="voice";a.ext=this.thumb("dummy");break;case 5:a.type="book";a.ext=this.thumb(a,"book");break;case 6:a.type=
"movie";a.ext=this.thumb(a,"movie");break;case 7:a.type="place";a.ext=this.thumb("dummy");break;case 8:a.type="weblink",a.ext=this.thumb(a,"weblink")}a.attached=this.attached(a.attachments)}a.datetime=this.date(a.time.start||a.time.created);a.endtime="";a.time.end&&(a.datetime+=" - "+this.date(a.time.end,1));var c=$(app.itemView(a));c.find(" > a").on("click",function(a){a.preventDefault();animation.showMenuOnly("edit");app.photos&&app.photos.remove();$("#list").find("ul li:nth-child("+(app.currentDisplayed+
1)+") a").removeClass("display");$(this).addClass("display");app.currentDisplayed!=$(this).parent().index()&&(app.currentDisplayed=$(this).parent().index(),$("#detail").hide().fadeIn(500),app.view=new app.detail);return!1});a.contentType!==app.contentType.BULB&&($(".thumb > img:not([style])",c).on("load",function(){var a=app.util.crop(this.naturalWidth||this.width,this.naturalHeight||this.height,160);$(this).css(a)}),$(".thumb > canvas",c).each(function(){var a=new Image,b=this.getContext("2d");a.src=
$(this).data("src");a.onload=function(){var c=app.util.crop(this.width,this.height,160);b.drawImage(a,c.marginLeft||0,c.marginTop||0,c.width||160,c.height||160)}}));c=c.addClass(a.type).hide();this.contents.append(c.fadeIn(500))},htmlEmpty:function(){return $("#list ul").append("<li></li>")},thumb:function(a,b){var c=a[b],d;if(c&&0<c.length){c=c[0];d="";if(!c.fileName)return'<div class="dummy"></div>';if("images"!=b&&"video"!=b)if(c.thumb)c=c.thumb;else return'<div class="dummy"></div>';var e=app.util.crop(1024,
720,80),e=app.util.style(e),f;if("images"==b&&(journal.archive.map[c.fileName]&&(f=journal.archive.map[c.fileName].url),void 0==f)||"video"==b&&(journal.archive.map[c.fileName+"_thumb.jpg"]&&(f=journal.archive.map[c.fileName+"_thumb.jpg"].url),void 0==f))return'<div class="dummy"></div>';e&&(e=' style="'+e+'"');e='<img src="'+f+'"'+e+">";Modernizr.canvas&&(e="<canvas style=\"background-image: url('"+f+"')\"></canvas>");1<c.urlType&&"weblink"==b&&(d='<span class="weblink-video"></span>');"video"==
b&&(d='<span class="video-play"></span>');d='<div class="thumb">'+e+""+d+"</div>"}return d||'<div class="dummy"></div>'},attached:function(a){var b=[];a=app.tag().content(a);for(var c=0,d=a.length;c<d;++c)b.push('<span class="'+a[c]+'"></span>');return b.join("")},isInRange:function(a,b){var c=this.queryCache[a];if(!c){var c=[0,0],d=a.split(":");1==d.length?c=this.getTimeRange(d[0]):(c[0]=this.getTimeRange(d[0])[0],c[1]=this.getTimeRange(d[1])[1]);this.queryCache[a]=c}return b>=c[0]&&b<=c[1]},getTimeRange:function(a){var b=
[0,0];if(4==a.length){var c=parseInt(a.substr(0,2));a=parseInt(a.substr(2))+2E3;isNaN(c)||isNaN(a)||(b[0]=(new Date(a,c-1)).getTime(),b[1]=(new Date(a,c)).getTime()-1)}else if(6==a.length){var c=parseInt(a.substr(0,2)),d=parseInt(a.substr(2,2));a=parseInt(a.substr(4))+2E3;isNaN(a)||isNaN(c)||isNaN(d)||(b[0]=(new Date(a,c-1,d)).getTime(),b[1]=b[0]+86399999)}return b},isInSameMonth:function(a,b){var c=(new Date(a)).getMonth();return 0===b?app.monthArray[c]:(new Date(b)).getMonth()===c?-1:app.monthArray[c]}};
...
a.iconTags=c.iconTags||[],a.textTags=c.textTags||[]):(a.iconTags=[],a.textTags=[]);for(var b="video weblink book music movie images voice place textTags iconTags".split(" "),c=0,d=b.length;c<d;++c)void 0==a[b[c]]&&(a[b[c]]=void 0)}a.processed=1}c=$(app.detailView(a));app.cDetail.css("display","inline-block").html(c);app.app.addClass("detail-view");$(".content.loading").removeClass("loading");a.images?$("#menu-show-images").removeClass("hidden"):$("#menu-show-images").addClass("hidden");$(".icontags > span").on("click",
...
archive.protect=function(a){getTokenCallback(function(b){for(var c={},d=0,e=0;e!==archive.data.length;++e){var f=archive.data[e];f&&(f.protect?"_"!==f.name.substring(0,1)&&(c[f.id]="_"+f.name):"_"===f.name.substring(0,1)&&(c[f.id]=f.name.substring(1)))}f=Object.keys(c);if(0===f.length)animation.log(log.ARCHIVE_NO_PROTECT_CHANGE),a();else{animation.log(log.ARCHIVE_PROTECT_START,1);for(var e=0,g=f.length;e!==g;++e){var k=f[e];$.ajax({type:"PATCH",url:"https://api.onedrive.com/v1.0/drive/items/"+k+"?select=id&access_token="+
b,contentType:"application/json",data:JSON.stringify({name:c[k]})}).done(function(a){delete c[a.id]}).fail(function(a,b,d){c[data.id]=d}).always(function(){if(++d>=g){if(0!==Object.keys(c).length)for(var b=0;b!==archive.data.length;++b)c[archive.data[b].id]&&animation.error(log.ARCHIVE_PROTECT_FAIL+archive.data[b].name+log.SERVER_RETURNS_END+log.SERVER_RETURNS+c[data.id]+log.SERVER_RETURNS_END);animation.log(log.ARCHIVE_PROTECT_END,-1);a()}})}}})};
...
function backupAll(a){getTokenCallback(function(b){animation.log(log.CONTENTS_BACKUP_START);a=a||app.years;network.init(a.length-1);for(var c=0;c!==a.length;++c){var d=new Date,e=d.getMonth()+1,f=d.getDate(),g=d.getFullYear()%100,k=d.getHours(),h=d.getMinutes(),l=d.getSeconds(),d=a[c],e=10>e?"0"+e:e,f=10>f?"0"+f:f,g=10>g?"0"+g:g,k=10>k?"0"+k:k,h=10>h?"0"+h:h,l=10>l?"0"+l:l,e={name:"data_"+e+f+g+"_"+k+h+l+".js"};$.ajax({type:"POST",url:getCoreDataUrlHeader(!1,d)+":/action.copy?access_token="+b,contentType:"application/json",
...
function createFolders(a,b){getTokenCallback(function(c){var d=0,e=!1,f=["https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/core:/","https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/data:/","https://api.onedrive.com/v1.0/drive/root:/Apps/Journal/resource:/"],g={name:app.year.toString(),folder:{}};network.init(b);for(var k=0;k!==f.length;++k)$.ajax({type:"POST",url:f[k]+"children?access_token="+c,contentType:"application/json",data:JSON.stringify(g)}).done(function(){network.next();++d===
...
window.bulb=function(){function a(a){getTokenCallback(function(b){var d=bulb.getID(a);$.ajax({type:"GET",url:"https://api.onedrive.com/v1.0/drive/items/"+d+"/content?access_token="+b}).done(function(b,d,g){b=g.responseText;b=b.replace(/\r*\n/g," ");bulb.setRawContent(a,b);bulb.extractRawContent(a);bulb.mergeIntoArchive(a);animation.log(++e+log.BULB_PROCESSED_LEFT+c)}).always(function(){bulb.decrementTotalBulbs();0>=c&&app.finishMergingBulbs()})})}var b={},c=0,d=0,e=0;return{isProcessing:!1,initFetchData:function(b){bulb.isProcessing?
...
for(var c=0,d=b.length;c!=d;++c){var f={id:b[c].id,url:b[c]["@content.downloadUrl"]},e=bulb.getTimeFromEpoch(b[c].name);bulb.setData(e,f);a(e)}}}).fail(function(){bulb.isProcessing=!1})})},setdata:function(a,c){b[a]=c},getTimeFromEpoch:function(a){var b=parseInt(a.substr(0,2)),c=parseInt(a.substr(2,2)),d=2E3+parseInt(a.substr(4,2)),e=parseInt(a.substr(7,2)),m=parseInt(a.substr(9,2));a=parseInt(a.substr(11,2));return(new Date(d,b-1,c,e,m,a)).getTime()},extractRawContent:function(a){var c=/(.+)@(https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*))(.*)/g.exec(b[a].contentRaw);
...
setIsMerged:function(a){b[a].isMerged=!0},setTotalBulbs:function(a){d=c=a},decrementTotalBulbs:function(){--c},getTotalBulbs:function(){return c},getTotalAvailableBulbs:function(){return d},getMergedBulbCounter:function(){return e},setData:function(a,c){b[a]=c},clearData:function(){b={}},removeUploadedBulbs:function(){for(var a in b)b.hasOwnProperty(a)&&b[a].isMerged&&removeFileById(b[a].id,void 0,void 0,function(){0===--e&&(bulb.isProcessing=!1,animation.log(log.BULB_FETCH_FINAL_END))})},getBulbData:function(){return b},
...
stats.getYearSum=function(){for(var a=0,b=0,c=0,d=0,e=0,f=0,g=0;g!==journal.archive.data[app.year].length;++g){var k=journal.archive.data[app.year][g];if(stats.isInTimeRange(k.time.created)){a+=k.text.chars||0;b+=k.text.lines||0;if(k.time.end){var h=(k.time.end-k.time.start)/6E4;isNaN(h)||(c+=h)}k.images&&(d+=k.images.length);k.video&&(e+=k.video.length);k.voice&&(f+=k.voice.length)}}$("#total-char").text(a);$("#total-line").text(b);a=c%60;10>a&&(a="0"+a);$("#total-time").text(Math.floor(c/60)+":"+
a);$("#total-image").text(d);$("#total-video").text(e);$("#total-voice").text(f)};
stats.getResult=function(a){a=a.split("|");var b;b=stats.isLeapYear?Array(366):Array(365);for(var c=0;c!==journal.archive.data[app.year].length;++c){var d=[],e=journal.archive.data[app.year][c],f=e.time.created;if(stats.isInTimeRange(f))for(f=stats.getDayNumber(f),d.push(e.text.body),this.options.isIncludingTags&&d.push(e.tags),this.options.isIncludingTitles&&d.push(e.title),e=0;e!==d.length;++e){var g=d[e];if(g)for(var k=0;k!==a.length;++k){var h=a[k];b[f]||(b[f]=0);b[f]+=(g.match(new RegExp(h,"gi"))||
...
stats.showGraph=function(a){var b;stats.isGraphDisplayed=!0;var c=[],d=[],e;if(a)d=app.monthArray,$("#stats-table tbody tr").each(function(){var a=[];$(this).children("td").each(function(b){0===b?e=$(this).children("input").val():13>b&&a.push($(this).html())});c.push({name:e,data:a})});else{var f;a=0;for(f=Object.keys(stats.entries);a!==f.length;++a)if(e=f[a],c.push({name:f[a],data:stats.entries[e]}),0===a){var g=stats.entries[e];for(b=0;b!==g.length;++b)void 0!=g[b]&&d.push(stats.eachDay[b])}}for(a=
...
window.map=function(){var a={path:"M 0,0 0,0 z",fillOpacity:.8,scale:1,strokeColor:"red",strokeWeight:10},b=!1,c,d,e,f=0,g=[],k=[],h=-1,l=function(){for(var b=[],h=new google.maps.LatLngBounds,l=0,t=journal.archive.data[app.year].length;l<t;++l){var r=journal.archive.data[app.year][l];r.contentType===app.contentType.BULB&&r.place&&function(e){var l={lat:parseFloat(e.place.latitude),lng:parseFloat(e.place.longitude)};b.push(l);h.extend(l);l=new google.maps.Marker({position:l,icon:a,map:c,title:(new Date(e.time.created)).toString()});
e='<div class="map-infowindow-container"><p class="bulb-date">'+(new Date(e.time.created)).toString()+'</p><p class="bulb-content">'+e.text.body+'</p><p class="location">'+(e.place.title||"")+'</p><div class="map-actions"><a href="javascript:;" onclick="map.showOlderBulb()" id="bulb-map-prev"></a><a href="javascript:;" onclick="map.showLaterBulb()" id="bulb-map-next"></a></div></div>';var q=g.length;l.addListener("mouseover",function(){m(q)});l.addListener("mouseout",function(){clearTimeout(f);f=
setTimeout(function(){d.close()},5E3)});l.addListener("click",function(){});g.push(l);k.push(e)}(r)}e=new google.maps.Polyline({path:b,geodesic:!0,strokeColor:"black",strokeOpacity:.7,strokeWeight:1});e.setMap(c);c.fitBounds(h)},m=function(a){a=a||h;clearTimeout(f);h=a;d.setContent(k[a]);d.open(c,g[a]);c.setCenter(g[a].position);c.setZoom(15)};return{init:function(){c=new google.maps.Map(document.getElementById("map"),{zoom:4,center:{lat:-25.363,lng:131.044}});d=new google.maps.InfoWindow;b=!0;map.show()},
show:function(){$("#list-tab").removeClass("list-only");b?(map.reset(),l()):map.init()},showOlderBulb:function(){++h>=g.length&&(h=g.length-1);m()},showLaterBulb:function(){0>--h&&(h=0);m()},hide:function(){$("#list-tab").addClass("list-only")},reset:function(){e&&e.setMap(null);for(var a=0;a<g.length;++a)g[a].setMap(null);g=[];k=[];h=-1}}}();
